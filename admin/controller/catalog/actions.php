		...
		private function getForm() {
			...
			foreach ($this->data['languages'] as $language){
				...
				if (!empty($this->data['actions_description'][$language['language_id']])){
					if ($this->data['actions_description'][$language['language_id']]['image_overload'] && file_exists(DIR_IMAGE . $this->data['actions_description'][$language['language_id']]['image_overload'])){
						...
						$this->data['actions_description'][$language['language_id']]['thumb_overload'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
					}
					
					if ($this->data['actions_description'][$language['language_id']]['image_to_cat_overload'] && file_exists(DIR_IMAGE . $this->data['actions_description'][$language['language_id']]['image_to_cat_overload'])){
						...
						$this->data['actions_description'][$language['language_id']]['thumb_to_cat_overload'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
					}
				}
			}
			...
			$this->load->model('tool/image');
			if (isset($actions_info) && $actions_info['image'] && file_exists(DIR_IMAGE . $actions_info['image_to_cat'])) {
