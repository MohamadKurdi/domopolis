		...
		protected function getList() {
			...
			foreach ($results as $result) {
				...
				if ($real_category['yandex_category_name']){
					//$exploded = explode('/', $real_category['yandex_category_name']);					
					//$yandex_category_name = array_pop($exploded);
				...
				'intersections'				=> $real_category['intersections'],
				'feeds'       				=> $this->model_catalog_category->getFeeds($real_category['category_id']),
