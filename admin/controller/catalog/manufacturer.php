...
class ControllerCatalogManufacturer extends Controller { 
	...
	protected function getForm() {
		...
		if (isset($this->request->post['back_image']) && file_exists(DIR_IMAGE . $this->request->post['back_image'])) {
			$this->data['back_thumb'] = $this->model_tool_image->resize($this->request->post['back_image'], 100, 100);
		} elseif (!empty($manufacturer_info) && $manufacturer_info['back_image'] && file_exists(DIR_IMAGE . $manufacturer_info['back_image'])) {
		...
		} elseif (!empty($manufacturer_info) && $manufacturer_info['banner'] && file_exists(DIR_IMAGE . $manufacturer_info['banner'])) {
