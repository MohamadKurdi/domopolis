...
class ControllerFeedHotlineYml extends Controller {
	...
	public function index() {
		...
		$this->data['breadcrumbs'][] = array(
			'href'      => $this->url->link('feed/hotline_yml', 'token=' . $this->session->data['token'], 'SSL'),
			'text'      => $this->language->get('heading_title'),
			'separator' => ' :: '
		);

		$this->data['action'] = $this->url->link('feed/hotline_yml', 'token=' . $this->session->data['token'], 'SSL');
