...
class ControllerModuleCategoryWall extends Controller {
	...
	public function index() {
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/category_wall', 'token=' . $this->session->data['token']),
			'separator' => ' :: '
		);

		$this->data['action'] = $this->url->link('module/category_wall', 'token=' . $this->session->data['token']);
