...
class ControllerPaymentBankTransfer extends Controller {
	...
	public function index() {
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('payment/bank_transfer', 'token=' . $this->session->data['token']),
			'separator' => ' :: '
		);

		$this->data['action'] = $this->url->link('payment/bank_transfer', 'token=' . $this->session->data['token']);
		...
		if (isset($this->request->post['bank_transfer_ismethod'])) {
			$this->data['bank_transfer_ismethod'] = $this->request->post['bank_transfer_ismethod'];
		} else {
			$this->data['bank_transfer_ismethod'] = $this->config->get('bank_transfer_ismethod'); 
		} 
