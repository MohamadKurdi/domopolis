...
class ControllerPaymentLiqPay extends Controller
{
 	...
 	public function index()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('liqpay', $this->request->post, $store_id);
		...
		if (isset($this->request->post['liqpay_total'])) {
			...
			$this->data['liqpay_total'] = $liqpay_config['liqpay_total'];
		}
		...
		if (isset($this->request->post['liqpay_order_status_id'])) {
			...
			$this->data['liqpay_order_status_id'] = $liqpay_config['liqpay_order_status_id'];
		}
		...
		if (isset($this->request->post['liqpay_geo_zone_id'])) {
			...
			$this->data['liqpay_geo_zone_id'] = $liqpay_config['liqpay_geo_zone_id'];
		}
		...
		if (isset($this->request->post['liqpay_status'])) {
			...
			$this->data['liqpay_status'] = $liqpay_config['liqpay_status'];
		}
		
		if (isset($this->request->post['liqpay_status_fake'])) {
			$this->data['liqpay_status_fake'] = $this->request->post['liqpay_status_fake'];
		} else {
			$this->data['liqpay_status_fake'] = $liqpay_config['liqpay_status_fake'];
		}
		
		if (isset($this->request->post['liqpay_ismethod'])) {
			$this->data['liqpay_ismethod'] = $this->request->post['liqpay_ismethod'];
		} else {
			$this->data['liqpay_ismethod'] = $liqpay_config['liqpay_ismethod'];
		}

		if (isset($this->request->post['liqpay_sort_order'])) {
			$this->data['liqpay_sort_order'] = $this->request->post['liqpay_sort_order'];
		} else {
			$this->data['liqpay_sort_order'] = $liqpay_config['liqpay_sort_order'];
		}

		if (isset($this->request->post['liqpay_pay_way'])) {
			$this->data['liqpay_pay_way'] = $this->request->post['liqpay_pay_way'];
		} else {
			$this->data['liqpay_pay_way'] = $liqpay_config['liqpay_pay_way'];
		}

		if (isset($this->request->post['liqpay_language'])) {
			$this->data['liqpay_language'] = $this->request->post['liqpay_language'];
		} else {
			$this->data['liqpay_language'] = $liqpay_config['liqpay_language'];
		}
