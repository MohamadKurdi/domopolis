...
class ControllerPaymentPPPro extends Controller {
	...
	public function index() {
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('payment/pp_pro', 'token=' . $this->session->data['token']),
			'separator' => ' :: '
		);

		$this->data['action'] = $this->url->link('payment/pp_pro', 'token=' . $this->session->data['token']);
		...
		if (isset($this->request->post['pp_pro_ismethod'])) {
			$this->data['pp_pro_ismethod'] = $this->request->post['pp_pro_ismethod'];
		} else {
			$this->data['pp_pro_ismethod'] = $this->config->get('pp_pro_ismethod');
		}
