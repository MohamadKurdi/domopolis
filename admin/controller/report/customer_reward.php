...
class ControllerReportCustomerReward extends Controller {
	public function index() {     
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/customer_reward', 'token=' . $this->session->data['token'] . $url),
			'separator' => ' :: '
		);
		...
		$pagination->url = $this->url->link('report/customer_reward', 'token=' . $this->session->data['token'] . $url . '&page={page}');
