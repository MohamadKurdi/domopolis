	...
	class ControllerSaleOrder extends Controller {
		...
		public function getForm($return_data = false, $return_order_id = false) {
			...
			foreach ($order_products as $order_product) {
				...
				'amzn_no_offers'   => $real_product['amzn_no_offers'],
				'amzn_last_offers' => $real_product['amzn_last_offers'],
				'amzn_ignore'      => $real_product['amzn_ignore'],
				'amazon_best_price'=> $this->currency->format($real_product['amazon_best_price'], 'EUR', 1),
				'amazon_lowest_price'      => $this->currency->format($real_product['amazon_lowest_price'], 'EUR', 1),
				'good'             => $order_product['good'],
				'taken'            => $order_product['taken'],
				'option'           => $order_option,
				'download'         => $order_download,
				...
				'quantity_stockMN'   	=> $real_product['quantity_stockMN'],
				'quantity_stockAS'   	=> $real_product['quantity_stockAS'],
				'quantity_stock_onway'   		=> $real_product['quantity_stock_onway'],
				'quantity_stockM_onway'   		=> $real_product['quantity_stockM_onway'],
				'quantity_stockK_onway'   		=> $real_product['quantity_stockK_onway'],
				'quantity_stockMN_onway'   		=> $real_product['quantity_stockMN_onway'],
				'quantity_stockAS_onway'   		=> $real_product['quantity_stockAS_onway'],
