	...
	class ControllerUserContent extends Controller {
		...
		private function getList(){
			...
			$this->data['periods']['month'] = [				
				'date_from' => date('Y-m-d', strtotime('first day of this month')),
				'date_to' 	=> date('Y-m-d'),
				'href' 		=> $this->url->link('user/content', 'period=month' .'&token=' . $this->session->data['token'], 'SSL'), 	
			...
			$this->data['periods']['prev_month'] = [				
				...
				'href' 		=> $this->url->link('user/content', 'period=prev_month' .'&token=' . $this->session->data['token'], 'SSL'), 
			...
			$this->data['periods']['today'] = [				
				...
				'date_to' 	=> date('Y-m-d'),
				'href' 		=> $this->url->link('user/content', 'period=today' .'&token=' . $this->session->data['token'], 'SSL'), 
				'name' 		=> 'Сегодня' 				
			];
			...
			$this->data['periods']['yesterday'] = [				
				...
				'href' 		=> $this->url->link('user/content', 'period=yesterday' .'&token=' . $this->session->data['token'], 'SSL'), 
				'name' 		=> 'Вчера' 				
			];
