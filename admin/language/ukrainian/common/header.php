...
$_['text_subscribe']                   = 'Подписка на новости';
...
$_['text_ocfilter']                      = 'Теги, фильтра';

/* Admin Header Notices 1.0 */
$_['text_new_order']                   = 'Новые заказы';
$_['text_pending_order']                   = 'Ожидающие заказы';
$_['text_new_customer']             = 'Новые клиенты';
$_['text_pending_customer']                      = 'Ожидающие клиенты';
$_['text_pending_review']                      = 'Ожидающие отзывы';
$_['text_pending_affiliate']                     = 'Ожидающие партнеры';
$_['text_notification']                    = 'У вас уведомления';
$_['text_stockout']                    = 'Закончились на складе';
$_['text_review_category']                      = 'Отзывы о Категориях';
/* Admin Header Notices 1.0 */
$_['text_report_affiliate_statistics'] = 'Статистика';
$_['text_report_affiliate_statistics_all'] = 'Общая статистика';
...
$_['text_addspecials']   = 'Пакетное добавление спецпредложений';
?>