...
$_['text_show_help_note'] = 'Для получения справки нажмите на иконку &nbsp;<img style="vertical-align: middle" src="view/template/csvprice_pro/q.png" width="12" height="12" class="f-icon-helper q_sign" alt="Show help">';