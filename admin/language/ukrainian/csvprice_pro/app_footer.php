...
$_['text_show_help_note'] = 'Для отримання довідки натисніть на іконку &nbsp;<img style="vertical-align: middle" src="view/image/csvprice_pro/q.png" width="12" height="12" class="f-icon-helper q_sign" alt="Show help">';