...
$_['text_order_status_id'] = 'ID статуса заказа';
$_['text_description'] = 'Описание';
$_['text_amount'] = 'Сумма';
$_['text_comment'] = 'Комментарий';
$_['text_success_import'] = 'Импорт данных завершён!<br />Всего обработано <b>%s</b> строк!<br /><br /> Обновлено: <b>%s</b><br />Пропущено: <b>%s</b>';
$_['text_notify'] = 'Уведомить о заказе';
$_['text_amount_notify'] = 'Уведомить о транзакции';
