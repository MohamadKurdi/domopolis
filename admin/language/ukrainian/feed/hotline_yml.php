...
$_['entry_data_feed']    = 'Адрес экспорта:<br/><span class="help">Если вы формируете файл экспорта скриптом по запросу хотлайна.</span>';
...
$_['entry_shopname']     = 'Название магазина:<br/><span class="help">Короткое название магазина (название, которое выводится в списке найденных на хотлайн.Маркете товаров. Не должно содержать более 20 символов).</span>';
...
$_['entry_currency']     = 'Валюта предложений:<br/><span class="help">хотлайн.Маркет принимает предложения в валюте RUR, RUB, BYR, KZT или UAH. Выберите валюту в которой будут передаваться предложения.</span>';
...
$_['entry_numpictures']  = 'Кол-во картинок товара:<br/><span class="help">Сколько фотографий товара экспортировать. хотлайн принимает не более десяти.</span>';

$_['tab_categories'] 	 = 'Что экспортировать';
$_['entry_category']     = 'Категории:<br/><span class="help">Отметьте категории из которых надо экспортировать предложения для хотлайн.Маркета.<br />Если ничего не отмечено, то будут выгружаться все категории.</span><br/>Категории хотлайн<br/><span class="help">В правом поле ввода можно указать каким <a href="http://cards2.yandex.net/hlp-get/6213/xls/category_tree-.xls">категориям хотлайн</a> соответствуют ваши категории, например: "Одежда&nbsp;и&nbsp;обувь/Обувь/Мужская/Кеды"Б.</span>';
$_['entry_manufacturers'] = 'Производители:<br/><span class="help">Отметьте производителей, товары которых надо экспортировать в хотлайн.Маркет.<br />Если ничего не отмечено, то будут выгружаться товары всех производителей.</span>';
...
$_['tab_attributes_description'] = 'хотлайн рекомендует в экспорте разделять значение атрибута и единицу измерения.
...
$_['entry_attributes'] 	 = 'Экспортруемые атрибуты:<br/><span class="help">Выбранные атрибуты, если они присутствуют у товара, будут экспортироваться в хотлайн.Маркет (в виде тэгов &lt;param&gt;).</span>';
...
$_['entry_product_rel'] = 'Выгружать сопутствующие товары в тэге &lt;rel&gt;:<br/><span class="help">Для хотлайн.Маркет</span>';
...
$_['tab_tailor'] 		 = 'Опции';
$_['tab_tailor_description'] = 'Для каждого товара у которого можно выбрать цвет и размер, в хотлайн будет выгружаться несколько товарных предложений - для
								каждого сочетания цвет-размер. Опция &quot;цвет&quot; для одежды обязательна. Подробнее смотрите
								<a href="http://help.hotline.ru/partnermarket/?id=1124379">документацию хотлайн.Маркет</a>.';
