...
// Heading
$_['heading_title']         = 'Промсвязьбанк, v1.1';
...
$_['text_shoputils_psb']          = '<a onclick="window.open(\'http://www.psbank.ru/Business/Everyday/Acquiring/Internet\');"><img src="view/image/payment/shoputils_psb.png" alt="Промсвязьбанк" title="Промсвязьбанк" /></a>';
$_['text_copyright']      	      = 'Модуль оплаты "%s" разработан <a href="https://opencartforum.com/user/3463-shoputils/" target="_blank">ShopUtils</a>. Вопросы по техподдержке и работе модуля отправляйте через сайт <a href="http://opencart.shoputils.ru/?route=information/contact" target="_blank">http://opencart.shoputils.ru</a>.<br />&copy; ShopUtils 2010 &mdash; %s';
...
$_['help_test_mode']      = 'При включенном тестовом режимы все запросы будут отправляться на тестовый шлюз банка: http://193.200.10.117:8080/pit/merchant_test_page_purchase.html (Внимание! После заключения договора с банком и перевода банком Вашего сайта в "боевой режим" - Тестовый режим необходимо выключить.)';
