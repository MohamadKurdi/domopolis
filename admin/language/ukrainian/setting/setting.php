<?php
	...
	$_['entry_sms_message']        = 'Текст сообщения:<br/><span class="help">Можно использовать теги:<br/>{SNAME} - название магазина<br/>{ID} - номер заказа<br/>{DATE} - дата заказа<br/>{TIME} - время заказа<br/>{SUM} - сумма заказа<br/>{FIRSTNAME} - имя клиента<br/>{LASTNAME} - фамилия клиента<br/>{PRODUCTS} - список товаров<br/>{PHONE} - телефон клиента</span>';
	...
	$_['entry_sms_prkey']             = 'Приватный ключ';
	$_['entry_sms_pukey']           = 'Публичный ключ';
	...
	$_['entry_customer_price']    = 'Показывать цены только залогиненным:<br /><span class="help">Показывать цены только зарегистрированным покупателям.</span>';
