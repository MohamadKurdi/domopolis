<?php
	class ModelCatalogInformation extends Model {
		public function addInformation($data) {
			...
			if ($data['keyword']) {
				foreach ($data['keyword'] as $language_id => $keyword) {
					if ($keyword) {$this->db->query("INSERT INTO url_alias SET query = 'information_id=" . (int)$information_id . "', keyword = '" . $this->db->escape($keyword) . "', language_id = " . $language_id);}
				}
			}
			
			$this->load->model('kp/content');
			$this->model_kp_content->addContent(['action' => 'add', 'entity_type' => 'information', 'entity_id' => $information_id]);
		...
		public function editInformation($information_id, $data) {
			...
			$this->load->model('kp/content');
			$this->model_kp_content->addContent(['action' => 'edit', 'entity_type' => 'information', 'entity_id' => $information_id]);
		...
		public function deleteInformation($information_id) {
			...
			$this->load->model('kp/content');
			$this->model_kp_content->addContent(['action' => 'delete', 'entity_type' => 'information', 'entity_id' => $information_id]);
		}	
