<?php
	class ModelCatalogInformation extends Model {
		public function addInformation($data) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', status = '" . (int)$data['status'] . "', image = '" . $this->db->escape($data['image']) . "', igroup = '" . $this->db->escape($data['igroup']) . "', show_category_id = '" . (int)$data['show_category_id'] . "'");
		...
		public function editInformation($information_id, $data) {
			$this->db->query("UPDATE " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', status = '" . (int)$data['status'] . "', image = '" . $this->db->escape($data['image']) . "', igroup = '" . $this->db->escape($data['igroup']) . "', show_category_id = '" . (int)$data['show_category_id'] . "' WHERE information_id = '" . (int)$information_id . "'");
