...
class ModelCataloglandingpage extends Model {
	public function addlandingpage($data) {
		...
		$this->model_kp_content->addContent(['action' => 'add', 'entity_type' => 'landingpage', 'entity_id' => $landingpage_id]);
		
		return (int)$landingpage_id;
	}
	...
	public function editlandingpage($landingpage_id, $data) {
		...
		$this->load->model('kp/content');
		$this->model_kp_content->addContent(['action' => 'edit', 'entity_type' => 'landingpage', 'entity_id' => $landingpage_id]);
	...
	public function deletelandingpage($landingpage_id) {
		...
		$this->load->model('kp/content');
		$this->model_kp_content->addContent(['action' => 'delete', 'entity_type' => 'landingpage', 'entity_id' => $landingpage_id]);
	}	
