...
class ModelCatalogOption extends Model {
	public function addOption($data) {
		...
		$this->model_kp_content->addContent(['action' => 'add', 'entity_type' => 'option', 'entity_id' => $option_id]);
	...
	public function deleteOption($option_id) {
		...
		$this->load->model('kp/content');
		$this->model_kp_content->addContent(['action' => 'delete', 'entity_type' => 'option', 'entity_id' => $option_id]);
	}
