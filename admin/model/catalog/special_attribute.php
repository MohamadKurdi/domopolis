...
class ModelCatalogSpecialAttribute extends Model
{
    ...
    {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM special_attribute WHERE special_attribute_name = '" . $special_attribute_name . "' AND special_attribute_group_id = '" . (int)$special_attribute_group_id . "'");
    ...
    {
        $query = $this->db->query("SELECT * FROM special_attribute WHERE special_attribute_group_id = '" . (int)$special_attribute_group_id . "'");
    ...
    {
        $query = $this->db->query("SELECT * FROM special_attribute WHERE special_attribute_name = '" . $special_attribute_name . "' AND special_attribute_group_id = '" . (int)$special_attribute_group_id . "' LIMIT 1");
