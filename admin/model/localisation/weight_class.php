...
class ModelLocalisationWeightClass extends Model {
	public function addWeightClass($data) {
		$this->db->query("INSERT INTO weight_class SET value = '" . (float)$data['value'] . "', amazon_key = '" . $this->db->escape($data['amazon_key']) . "', system_key = '" . $this->db->escape($data['system_key']) . "', variants = '" . $this->db->escape($data['variants']) . "'");
	...
	public function editWeightClass($weight_class_id, $data) {
		$this->db->query("UPDATE weight_class SET value = '" . (float)$data['value'] . "', amazon_key = '" . $this->db->escape($data['amazon_key']) . "', system_key = '" . $this->db->escape($data['system_key']) . "', variants = '" . $this->db->escape($data['variants']) . "' WHERE weight_class_id = '" . (int)$weight_class_id . "'");
