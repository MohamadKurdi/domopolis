...
class Modelmodulesocnetauth2 extends Model 
{
	...
	public function makeCode($data)
	{
		...
		#$template->data['socnetauth2_default'] = $data['socnetauth2_default'];
		#$template->data['socnetauth2_format'] = $data['socnetauth2_format'];
		$template->data['socnetauth2_label'] = $data['socnetauth2_label'];
		$template->data['socnetauth2_showtype'] = $data['socnetauth2_showtype'];
		
		
		if( $data['socnetauth2_showtype']=='window' )
		{
			$template->data['classname'] = 'socnetauth';	
		}
		else
		{
		...
		$template->data['socnetauth2_shop_folder'] = $this->config->get('socnetauth2_shop_folder');
		...
		foreach($this->socnets as $socnet)
		{
			...
			$template->data['socnetauth2_socnets'][] = $socnet;
		}
		
		if( $template->data['socnetauth2_shop_folder'] )
		$template->data['socnetauth2_shop_folder'] = '/'.$template->data['socnetauth2_shop_folder'];
		
		$data['socnetauth2_confirm_block'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_confirm.tpl');
		
		$template->data['socnetauth2_format'] = 'kvadrat';
		
		$data['socnetauth2_reg_code_kvadrat'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_reg.tpl');
		$data['socnetauth2_simplereg_code_kvadrat'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_simplereg.tpl');
		$data['socnetauth2_simple_code_kvadrat']    = $template->fetch('module/socnetauth2_blocks/socnetauth2_simple.tpl');
		$data['socnetauth2_account_code_kvadrat']   = $template->fetch('module/socnetauth2_blocks/socnetauth2_account.tpl');
		$data['socnetauth2_checkout_code_kvadrat']  = $template->fetch('module/socnetauth2_blocks/socnetauth2_checkout.tpl');
		
		$template->data['socnetauth2_format'] = 'bline';
		
		$data['socnetauth2_reg_code_bline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_reg.tpl');
		$data['socnetauth2_simplereg_code_bline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_simplereg.tpl');
		$data['socnetauth2_simple_code_bline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_simple.tpl');
		$data['socnetauth2_account_code_bline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_account.tpl');
		$data['socnetauth2_checkout_code_bline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_checkout.tpl');
		
		$template->data['socnetauth2_format'] = 'lline';
		
		$data['socnetauth2_reg_code_lline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_reg.tpl');
		$data['socnetauth2_simplereg_code_lline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_simplereg.tpl');
		$data['socnetauth2_simple_code_lline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_simple.tpl');
		$data['socnetauth2_account_code_lline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_account.tpl');
		$data['socnetauth2_checkout_code_lline'] = $template->fetch('module/socnetauth2_blocks/socnetauth2_checkout.tpl');
