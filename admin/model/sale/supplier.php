...
class ModelSaleSupplier extends Model {
	public function addSupplier($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "suppliers SET 
	...
	public function editSupplier($supplier_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "suppliers SET 
		supplier_name = '" . $this->db->escape($data['supplier_name']) . "',
		supplier_type = '" . $this->db->escape($data['supplier_type']) . "', 
		supplier_country = '" . $this->db->escape($data['supplier_country']) . "',
		supplier_code = '" . $this->db->escape($data['supplier_code']) . "', 
	...
	public function getSupplierByName($supplier) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "suppliers WHERE supplier_name = '" . $this->db->escape(trim($supplier)) . "'");
	...
	public function getOPSupply($order_product_id){
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "order_product_supply WHERE order_product_id = '" . (int)$order_product_id . "'");
		
		return $query->rows;
	}
	
	public function getOPSupplyForSet($set_product_id){
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "order_product_supply WHERE order_set_id = '" . (int)$set_product_id . "'");
