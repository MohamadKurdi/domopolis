...
if(jQuery) (function($){
	...
	function buildOptions(options)
	{
		...
		if( o.selectAll ) {
			html += '<label class="selectAll" style="background: #EEEEEE; font-weight: bold;"><input type="checkbox" class="selectAll" />' + o.selectAllText + '</label>';
		}
		...
		multiSelectOptions.find('INPUT:checkbox').click( function() {
			...
			$(this).parent("LABEL").removeClass('checked', $(this).prop('checked'));
		...
		multiSelectOptions.each( function() {
			$(this).find('INPUT:checked').parent().toggleClass('checked');
		});
