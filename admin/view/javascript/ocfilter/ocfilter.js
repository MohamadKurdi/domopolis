...
var ocfilter = {
	...
	**/
	setting: {
		init: function() {
			...
			$('tr.install-package').on('click', function() {
				$(this).select();
			});
	...
	**/
	productForm: {
		...
		length: null,
		init: function() {
			$('a[href=\'#tab-links\']').after('<a href="#tab-ocfilter" style="background-color: rgb(255, 120, 21); color: rgb(255, 255, 255); display: inline;">' + ocfilter.php.tab_ocfilter + '</a>');
