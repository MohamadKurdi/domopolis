  ...
  <tfoot>
   ...
   <tr>
    ...
    <form id="form-image_google<?php echo $product_id; ?>">
     <p>
      ...
      <a onclick="resetFolderImageGoogle('<?php echo $product_id; ?>');"><img src="view/batch_editor/image/reset.png" title="<?php echo $text_reset; ?>" alt="<?php echo $text_reset; ?>" /></a>
     ...
     <p><input name="image_google[keyword]" type="text" size="100" maxlength="128" value="<?php echo (isset ($keyword)) ? $keyword : ''; ?>" /> <a class="button" onclick="searchImageGoogle(<?php echo $product_id; ?>);"><?php echo $text_search; ?></a></p>
   ...
   <tr>
    <td class="center" colspan="2">
     <a class="button" onclick="editTool(<?php echo $product_id; ?>, 'image_google', 'add');"><?php echo $text_add; ?></a>
     <a class="button" onclick="resetImageGoogle(<?php echo $product_id; ?>);"><?php echo $text_reset; ?></a>
     <?php if ($product_id) { ?>
