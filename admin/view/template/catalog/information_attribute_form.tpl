                            ...
                            <td><div class="scrollbox">
								...
								<div class="<?php echo $class; ?>">
									<?php if (in_array(0, $information_store)) { ?>
                                        <input id="information_store[]" class="checkbox" type="checkbox" name="information_store[]" value="0" checked="checked" />
                                        <label for="information_store[]"><?php echo $text_default; ?></label>
                                        <?php } else { ?>
                                        <input id="information_store[]" class="checkbox" type="checkbox" name="information_store[]" value="0" />
                                        <label for="information_store[]"><?php echo $text_default; ?></label>
									<?php } ?>
								</div>
								<?php foreach ($stores as $store) { ?>
                                    ...
                                    <div class="<?php echo $class; ?>">
                                        <?php if (in_array($store['store_id'], $information_store)) { ?>
											<input id="<?php echo $store['store_id']; ?>" class="checkbox" type="checkbox" name="information_store[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
											<label for="<?php echo $store['store_id']; ?>"><?php echo $store['name']; ?></label>
											<?php } else { ?>
											<input id="<?php echo $store['store_id']; ?>" class="checkbox" type="checkbox" name="information_store[]" value="<?php echo $store['store_id']; ?>" />
											<label for="<?php echo $store['store_id']; ?>"><?php echo $store['name']; ?></label>
										<?php } ?>
									</div>
								<?php } ?>
