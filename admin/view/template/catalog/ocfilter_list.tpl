  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
        ...
        <a onclick="location = '<?php echo $ocfilter_page; ?>'" class="button">Посадочные страницы</a>
			</div>
    </div>
    <div class="content">
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left" width="15%"><?php echo $column_values; ?></td>
              <td class="left"><?php echo $column_categories; ?></td>
              <td class="left"><?php echo $column_type; ?></td>
              <td class="left">Поместить в список</td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right">
								...
								<label><input type="checkbox" class="edit" name="selectbox" value="1" for="<?php echo $option['option_id']; ?>" checked="checked" /><span><?php echo $text_enabled; ?></span></label>
								<?php } else { ?>
								<label><input type="checkbox" class="edit" name="selectbox" value="1" for="<?php echo $option['option_id']; ?>" /><span><?php echo $text_disabled; ?></span></label>
								<?php } ?>
							</td>
            ...
            <?php } ?>
            <?php } else { ?>
            <tr><td class="center" colspan="9"><?php echo $text_no_results; ?></td></tr>
            <?php } ?>
          </tbody>
        </table>
      </form>
