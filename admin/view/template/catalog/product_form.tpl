	...
	<div class="box">
		...
		<div class="content">
			<div id="tabs" class="htabs">
				...
				<a href="#tab-size" style="background-color:#7F00FF; color:#FFF;">Габариты</a>
				<a href="#tab-links" style="background-color:#ff7815; color:#FFF;"><?php echo $tab_links; ?></a>
				<a href="#tab-attribute" style="background-color:#ff7815; color:#FFF;"><?php echo $tab_attribute; ?></a>
								...
								<tr>
									...
									<td>
										...
										<div class="translate_wrap">
											<a class="btn-copy<?php echo $language['language_id']; ?> btn-copy" onclick="getCopy($(this),'input','product_description[2]');"><i class="fa fa-copy"></i> Копировать с ru</a>
											<?php if (in_array($language['code'], $this->config->get('config_translate_from_ru'))) { ?>
												<a class="btn-translate<?php echo $language['language_id']; ?> btn-translate" onclick="getTranslate($(this), 'ru','<?php echo $language['code']; ?>','input','product_description[2]');">Перевести <img src="view/image/flags/ru.png" /> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></a>
								...
								<tr>
									...
									<td>
										<div class="translate_wrap">
											<a class="btn-copy<?php echo $language['language_id']; ?> btn-copy" onclick="getCopy($(this),'input','product_description[2]');"><i class="fa fa-copy"></i> Копировать с ru</a>
											<?php if (in_array($language['code'], $this->config->get('config_translate_from_ru'))) { ?>
												<a class="btn-translate<?php echo $language['language_id']; ?> btn-translate" onclick="getTranslate($(this), 'ru','<?php echo $language['code']; ?>','input','product_description[5]');">Перевести <img src="view/image/flags/ru.png" /> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></a>
											<?php } elseif ($language['code'] == $this->config->get('config_admin_language')) { ?>
												<a class="btn-translate<?php echo $language['language_id']; ?> btn-translate" onclick="getTranslate($(this), 'de','<?php echo $language['code']; ?>','input','product_description[26]');">
													Перевести <img src="view/image/flags/de.png" /> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
												</a>
									...
									<tr>
										...
										<td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][name_of_option]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name_of_option'] : ''; ?>" />
											...
											<tr>
												...
												<td>
													<div class="translate_wrap">
														<a class="btn-copy<?php echo $language['language_id']; ?> btn-copy" onclick="getCopy($(this),'textarea','product_description[2]');"><i class="fa fa-copy"></i> Копировать с ru</a>
														<?php if (in_array($language['code'], $this->config->get('config_translate_from_ru'))) { ?>
															<a class="btn-translate<?php echo $language['language_id']; ?> btn-translate" onclick="getTranslate($(this), 'ru','<?php echo $language['code']; ?>','textarea','product_description[5]');">Перевести <img src="view/image/flags/ru.png" /> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></a>
														<?php } elseif ($language['code'] == $this->config->get('config_admin_language')) { ?>
															<a class="btn-translate<?php echo $language['language_id']; ?> btn-translate" onclick="getTranslate($(this), 'de','<?php echo $language['code']; ?>','textarea','product_description[26]');">
																Перевести <img src="view/image/flags/de.png" /> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
															</a>
														<?php } ?>
													</div>
											...
											<div id="tab-priceva">
												...
												<div id="tab-yandex-market">
													<table class="form">
														...
														<div id="tab-size">
															<table class="form">
																<tr><th colspan='4'>Размер, вес товара  / НЕТТО</th></tr>	
																<tr>
