	...
	<div class="box">
		<div class="heading order_head">
			...
			<div class="buttons" style="padding-top:10px;padding-left:10px;">
				<a class="button <?php if ($filter_buybox_failed) { ?>active<? } ?>"  href="<?php echo $href_filter_buybox_failed; ?>"><i class="fa fa-exclamation-triangle"></i>  BBOX <?php if ($total_buybox_failed) { ?>(<?php echo $total_buybox_failed; ?>)<?php } ?></a>
				
				<a class="button <?php if ($filter_defaultoffer_failed) { ?>active<? } ?>"  href="<?php echo $href_filter_defaultoffer_failed; ?>"><i class="fa fa-exclamation-triangle"></i> DEFAULT <?php if ($total_defaultoffer_failed) { ?>(<?php echo $total_defaultoffer_failed; ?>)<?php } ?></a>	
				
				<a class="button <?php if ($filter_minpricemarket_failed) { ?>active<? } ?>"  href="<?php echo $href_filter_minpricemarket_failed; ?>"><i class="fa fa-exclamation-triangle"></i> MIN_PRICE <?php if ($total_minpricemarket_failed) { ?>(<?php echo $total_minpricemarket_failed; ?>)<?php } ?></a>
				
				<a class="button <?php if ($filter_is_illiquid) { ?>active<? } ?>" href="<?php echo $href_filter_is_illiquid; ?>"><i class="fa fa-exclamation-triangle"></i> Нлквд <?php if ($total_not_liquid) { ?>(<?php echo $total_not_liquid; ?>)<?php } ?></a>
				
				<a class="button <?php if ($filter_yam_hidden) { ?>active<? } ?>" href="<?php echo $href_filter_yam_hidden; ?>"><i class="fa fa-exclamation-triangle"></i> Скрыто <i class="fa fa-yahoo"></i> <?php if ($total_yam_hidden) { ?>(<?php echo $total_yam_hidden; ?>)<?php } ?></a>
				
				<a class="button <?php if ($filter_notinfeed) { ?>active<? } ?>" href="<?php echo $href_filter_notinfeed; ?>"><i class="fa fa-exclamation-triangle"></i> -фид <i class="fa fa-yahoo"></i> <?php if ($total_not_in_feed) { ?>(<?php echo $total_not_in_feed; ?>)<?php } ?></a>
				
				<a class="button <?php if ($filter_yam_not_created) { ?>active<? } ?>" href="<?php echo $href_filter_yam_not_created; ?>"><i class="fa fa-exclamation-triangle"></i> Нет карты <i class="fa fa-yahoo"></i> <?php if ($total_yam_not_created) { ?>(<?php echo $total_yam_not_created; ?>)<?php } ?></a>
