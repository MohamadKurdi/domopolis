		...
		<?php if ($this->config->get('admin_quick_edit_status') && ($this->config->get('aqe_alternate_row_colour') || $this->config->get('aqe_row_hover_highlighting'))) { ?>
			<style type="text/css">
				<?php if ($this->config->get('aqe_alternate_row_colour')) { ?>
					table.list tbody tr:not([class~=filter]):nth-child(even) td {background: #faf9f1 !important}
					table.list tbody tr:not([class~=filter]).selected_row td {background-color:#faf9f1 !important}
				<?php } ?>
				<?php if ($this->config->get('aqe_row_hover_highlighting')) { ?>
					...
					table[class=list] tbody tr:not([class~=filter]).selected_row:hover td {background: #faf9f1 !important}
				<?php } ?>
			</style>
		<?php } ?>
		<script type="text/javascript">
