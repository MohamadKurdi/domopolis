				...
				<?php if ($logged) { ?>
					...
					<div id="menu">	
						<ul class="right">
							...
							<li id="information"><a class="top"><i class="fa fa-info icon_menu"></i>Информация</a>
								<ul>
							...
							<?php /** ?>
								...
								<li><a href="<? echo $fucked_link; ?>">Незавершенные заказы <span style="color:red;">(<? echo $fucked_order_total; ?>)</span></a></li>
								<? } ?>
							...
							<li id="modules"><a class="top"><i class="fa fa-newspaper-o icon_menu"></i>Модули товаров</a>
								<ul>
						...
						<!--<ul class="right">
							<li id="store"><a class="top">Магазин</a>
							<ul>
							<a href="<?php echo $store; ?>" target="_blank" class="top">Основной</a>
							<?php foreach ($stores as $stores) { ?>
								<li><a href="<?php echo $stores['href']; ?>" target="_blank"><?php echo $stores['name']; ?></a></li>
