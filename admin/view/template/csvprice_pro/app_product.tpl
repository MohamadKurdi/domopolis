	...
	<div class="g f-content">
		...
		<div class="g-row">
				...
				<div class="g-row">
						<div class="g-7">
							...
							<div class="f-row">
								...
								<div class="f-input">
									<select class="g-2 f-margin-top" name="csv_export[category_parent]">
							...
							<!-- BEGIN FIlter -->
							<!-- <input type="hidden" name="csv_export[product_filter]" value="1" />-->
							<div>&nbsp;</div>
			...
			<div id="tab_import" class="f-tabs">
					...
					<div class="g-row">
						<div class="g-6 f-form">
							...
							<div class="f-row">
								...
								<div class="f-input">
									<select class="g-3" name="csv_import[mode]">
										<option value="2" <?php if ( isset($csv_import['mode']) && $csv_import['mode'] == 2 ) echo ' selected="selected"'; ?>> <?php echo $text_import_mode_update; ?></option>
										<option value="3" <?php if ( isset($csv_import['mode']) && $csv_import['mode'] == 3 ) echo ' selected="selected"'; ?>> <?php echo $text_import_mode_insert; ?></option>
										<option value="1" <?php if ( isset($csv_import['mode']) && $csv_import['mode'] == 1 ) echo ' selected="selected"'; ?>> <?php echo $text_import_mode_both; ?></option>
										<option value="4" <?php if ( isset($csv_import['mode']) && $csv_import['mode'] == 4 ) echo ' selected="selected"'; ?>> <?php echo $text_import_mode_supplement; ?></option>
							...
							<div class="f-row">
								...
								<div class="f-input">
									<select class="g-1 f-margin-top" name="csv_import[delimiter_category]">
							...
							<div class="f-row">
								...
								<div class="f-input">
									<select class="g-2 f-margin-top" name="csv_import[fill_category]">
							...
							<div class="f-row">
								...
								<div class="f-input">
									<select class="g-2" name="csv_import[calc_mode]">
							...
							<div class="f-row">
								...
								<div class="f-input">
									<select class="g-2 f-margin-top" name="csv_import[product_disable]">
							...
							<div class="f-row">
								...
								<div class="f-input">
									<input class="g-1 f-text-right f-margin-top" type="text" name="csv_import[iter_limit]" value="<?php echo $csv_import['iter_limit'];?>" />
								</div>
							</div>
							<div class="f-row">
								...
								<div class="f-input">
									...
									<div class="scrollbox">
										...
										<div class="<?php echo $class; ?>">
											...
											<label><input type="checkbox" name="csv_import[to_store][]" value="0" class="product_store" checked="checked" />
											<?php echo $text_default; ?></label>
											<?php } else { ?>
											<label><input type="checkbox" name="csv_import[to_store][]" value="0" class="product_store" />
											<?php echo $text_default; ?></label>
											<?php } ?>
										</div>
										<?php foreach ($stores as $store) { ?>
										...
										<div class="<?php echo $class; ?>">
											...
											<label><input type="checkbox" name="csv_import[to_store][]" value="<?php echo $store['store_id']; ?>" checked="checked" />
											<?php echo $store['name']; ?></label>
											<?php } else { ?>
											<label><input type="checkbox" name="csv_import[to_store][]" value="<?php echo $store['store_id']; ?>" />
											<?php echo $store['name']; ?></label>
											<?php } ?>
										</div>
										<?php } ?>
									</div>
									<a onclick="$('.product_store').attr('checked', true);"><?php echo $text_select_all; ?></a> / <a onclick="$('.product_store').attr('checked', false);"><?php echo $text_unselect_all; ?></a>
								</div>
								<!-- end f-input -->
							</div>
							<!-- end f-row -->
				...
				<div class="g-row">
					<div class="f-row"></div>
					<div class="f-actions-left"><a onclick="$('#form_product_import').submit();" class="f-bu f-bu-default g-2"><?php echo $button_import;?></a></div>
				</div>
			</div>
			<!-- end tab_import -->
			<div id="tab_macros" class="f-tabs">
				<div class="f-row">
