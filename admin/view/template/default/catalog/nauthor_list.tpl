...
<?php echo $newspanel; ?>
  <div class="box blogbox">
    <div class="heading order_head">
      ...
      <div class="buttons"><a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a><a onclick="$('form').submit();" class="button sterge"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($nauthor['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $nauthor['name']; ?></td>
              <td class="right"><?php foreach ($nauthor['action'] as $action) { ?>
