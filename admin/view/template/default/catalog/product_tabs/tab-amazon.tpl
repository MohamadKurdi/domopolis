...
<div style="margin-top:10px;" id="amazon_offers">
	<?php require_once($this->checkTemplate(dirname(__FILE__) , 'sale/amazon_offers_list')); ?>
</div>
...
<div style="margin-top:10px;" id="amazon_offers_history">
	<?php require_once($this->checkTemplate(dirname(__FILE__) , 'sale/amazon_offers_history')); ?>	
</div>
