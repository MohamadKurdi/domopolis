...
<div id="content">
    <style>
        table tr td{vertical-align:top;} h2, .box > .content h2 {font-size: 18px; clear: both; border-bottom: none; font-weight: 400} .tile-block{width:25%; float: left; margin-left:5px;} .tile-block.narrow

        {width:15%; float: left; margin-left:5px;}
        ...
        .tile-body {overflow: hidden; line-height: 44px; min-height: 50px;} .tile.good > .tile-heading, .tile.good > .tile-footer{background-color: #00ad07; } .tile.good > .tile-body{background-color: #00ad07;opacity: 0.8;} .tile.warn > .tile-heading, .tile.warn > .tile-footer{background-color: #ff7815; } .tile.warn > .tile-body{background-color: #ff7815;opacity: 0.8;} .tile.bad > .tile-heading, .tile.bad > .tile-footer{background-color: #ce1400; } .tile.bad > .tile-body{background-color: #ce1400;opacity: 0.8;} .tile.unknown > .tile-heading, .tile.unknown > .tile-footer{background-color: #24a4c1; } .tile.unknown > .tile-body{background-color: #24a4c1;opacity: 0.8;} .tile-result{color:#FFF; font-size:28px; max-height: 45px; line-height: 28px;} .tile-result.small{font-size: 14px; max-height: 45px; line-height: 14px;} .tile .tile-body i

        {font-size:28px;}

        .dashboard-heading{border-top-left-radius:5px; border-top-right-radius:5px;}
        .dashboard-content{border-bottom-left-radius:5px; border-bottom-right-radius:5px;}
    </style>
    <div class="box">
        <div class="content">
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td class="table-admin" style="width:60%;">
                            ...
                            <?php if ($stores_count == 1) { ?>style="width:100%;"<?php } ?> class="filters delayed-load" data-route='common/home/loadOrderStats'>
            </div>
                        ...
                        if ($(elem).attr('data-defer')) {
                            ...
                            if ($(elem).attr('data-update-interval')) {
                                setInterval(function () {
                                    updateStats(elem, uri);
                                }, $(elem).attr('data-update-interval'));
                                updateStats(elem, uri);
