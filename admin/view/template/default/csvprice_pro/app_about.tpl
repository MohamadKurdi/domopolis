	...
	<div class="g f-content">
		...
		<div class="g-row">
			<table style="margin:0;border-bottom: 1px solid #EEEEEE;">
				<tbody>
					<?php if(isset($entry_license_key)) { ?>
					<tr><td><?php echo $text_license_key;?></td><td><?php echo $license_key;?></td></tr>
					<?php } else {?>
					<tr><td><?php echo $text_license_key;?></td><td><a onclick="prompt('<?php echo $text_license_key;?>','<?php echo $license_key;?>'); return false;"><?php echo $text_show;?></a></td></tr>
					<?php } ?>
					<tr><td><?php echo $text_app_name;?></td><td><?php echo $app_name;?></td></tr>
					<tr><td><?php echo $text_app_version;?></td><td><?php echo $app_version;?></td></tr>
					<tr><td><?php echo $text_home_page;?></td><td><a href="http://<?php echo $home_page;?>" target="_blank"><?php echo $home_page;?></a></td></tr>
					<tr><td><?php echo $text_support_email;?></td><td><a href="mailto:<?php echo $support_email;?>"><?php echo $support_email;?></a></td></tr>
				</tbody>
			</table>
		</div>
	</div>
