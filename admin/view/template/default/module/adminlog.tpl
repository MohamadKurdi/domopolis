        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><span class="status_color_list <?php if(!$entry['allowed']){ ?>denied <?php } ?><?php echo $entry['action']; ?>"><a class="status_color_a" href="<?php echo $entry['user']; ?>" target="_blank"><?php echo $entry['user_name']; ?></a></span></td>
              <td class="left"><?php echo $entry['action']; ?></td>
              <td class="left"><?php echo $entry['allowed']; ?></td>
              <td class="left"><a class="status_color_a" href="<?php echo $entry['url_link']; ?>" target="_blank"><?php echo $entry['url']; ?></a></td>
