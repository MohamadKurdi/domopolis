            ...
            <tbody id="module-row<?php echo $module_row; ?>">
              <tr>
                ...
                <td class="left"><select name="alsopurchased_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php } ?>
                  <?php if ($module['position'] == 'content_product_middle') { ?>
                    <option value="content_product_middle" selected="selected">По центру</option>
                  <?php } else { ?>
                    <option value="content_product_middle">По центру</option>
                  <?php } ?>
                </select></td>
