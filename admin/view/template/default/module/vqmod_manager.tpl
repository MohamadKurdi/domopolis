...
<div class="box">
  ...
  <div class="content">
    ...
    <div id="tabs" class="htabs"><a href="#tab-scripts"><?php echo $tab_scripts; ?></a><a href="#tab-settings"><?php echo $tab_settings; ?></a><a href="#tab-error"><?php echo $tab_error_log; ?></a><a href="#tab-about"><?php echo $tab_about; ?></a><div class="clr"></div></div>
        ...
        <tbody>
          ...
          <tr class="<?php echo $class; ?>">
            ...
            <td class="action"><?php foreach ($vqmod['action'] as $action) { ?>
              <a class="button" class="action-link" href="<?php echo $action['href']; ?>"><?php echo $action['text']; ?></a>
              <?php } ?></td>
            <td class="action">
              <a class="button" class="action-link" href="<?php echo $vqmod['delete'] ?>"><i class="fa fa-trash-o"></i></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
