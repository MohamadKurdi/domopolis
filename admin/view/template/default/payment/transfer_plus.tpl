      ...
      <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
        <table class="form">
          <?php foreach ($languages as $language) {
           ...
           <tr>
            <td>Основной город оплаты (обычно - столица)
             <span class="help">Если это НЕ ПРЕДОПЛАТА, то способ показывается ТОЛЬКО для этих городов. Конструкция !,Город,г.Город делает наоборот - отключает показ метода для данных городов и не-предоплатного способа.</span>
           </td>
         ...
         <tr>
           <td>Настройки для основного города оплаты (выше)
            <span class="help">СУММА_ДО:ПРОЦЕНТ ПРЕДОПЛАТЫ. 100000:0,99999999999999999999:10</span>
          </td>
        ...
        <tr>
         <td>Настройки для иных регионов страны
          <span class="help">СУММА_ДО:ПРОЦЕНТ ПРЕДОПЛАТЫ. 10000:100,50000:20,100000:10,99999999999999999999:5</span>
        </td>
