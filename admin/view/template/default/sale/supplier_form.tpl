    ...
    <div class="box">
        <div class="heading order_head">
            ...
            <div class="buttons">
                ...
                <a href="<?php echo $offers_link; ?>" class="button"><i class="fa fa-amazon"></i> Посмотреть офферы
                    поставщика</a>
                <?php } ?>
        ...
        <div class="content">
            <div id="tabs" class="htabs">
                ...
                <a href="#tab-parser"><i class="fa fa-search"></i> Парсер, обновление</a>
                <a href="#tab-categories"><i class="fa fa-refresh"></i> Сопоставление категорий
                    поставщика <?php if (!empty($supplier_categories_total)) { ?>
                    (<?php echo $supplier_categories_total; ?>)<?php } ?></a>
                <a href="#tab-attributes"><i class="fa fa-refresh"></i> Сопоставление атрибутов
                    поставщика <?php if (!empty($supplier_attributes_total)) { ?>
                    (<?php echo $supplier_attributes_total; ?>)<?php } ?></a>
                <a href="#tab-manufacturers"><i class="fa fa-refresh"></i> Бренды
                    поставщика <?php if (!empty($supplier_manufacturers_total)) { ?>
                    (<?php echo $supplier_manufacturers_total; ?>)<?php } ?></a>
                <div class="clr"></div>
            </div>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            <div id="tab-info">
                    <div style="width:100%;">
                            ...
                            <tr style="border-bottom:1px dashed gray">
                                ...
                                <td>
                                    ...
                                    <select name="supplier_type">
                                        <? foreach ($_a as $_s) { ?>
                                        <option value="<? echo $_s; ?>"
                                        <? if ($supplier_type == $_s) { ?>selected="selected" <? } ?>
                                        ><? echo $_s; ?></option>
                                        <? } ?>
                                    </select>
                        ...
                        <table class="form">
                            <tr>
                                <td width="33%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">Рейтинг50</span>
                                </td>
                                <td width="33%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Всего отзывов</span>
                                </td>
                                <td width="33%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">Процент позитивных</span>
                                </td>
                            </tr>
                            <tr style="border-bottom:1px dashed gray">
                                <td>
                        ...
                        <table class="form">
                            <tr>
                                <td width="33%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">Amazon Приоритетный Поставщик</span>
                                </td>
                                <td width="33%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">Amazon Плохой Поставщик</span>
                                </td>
                                <td width="33%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">Amazon Произвольный Коэффициент</span>
                                </td>
                            </tr>
                        ...
                        <table class="form">
                            <tr>
                                <td width="14%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#00ad07; color:#FFF">Страна</span>
                                </td>
                                <td width="14%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#00ad07; color:#FFF">Телефон</span>
                                </td>
                                <td width="14%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#00ad07; color:#FFF">Почта</span>
                                </td>
                                <td width="14%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#00ad07; color:#FFF">Нативный поставщик</span>
                                </td>
                                <td width="14%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#00ad07; color:#FFF">Рынок</span>
                                </td>
                                <td width="14%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#00ad07; color:#FFF">Сортировка</span>
                                </td>
                                <td width="14%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#00ad07; color:#FFF">Описание / комментарий</span>
                                </td>
                            </tr>
                        ...
                        <table class="form">
                            <tr>
                                <td width="15%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">Коэффициент - 1</span>
                                </td>
                                <td width="15%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">Коэффициент - 2</span>
                                </td>
                                <td width="15%">
                        ...
                        <table class="form">
                            <tr>
                                <td width="50%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">About this Seller</span>
                                </td>
                                <td width="50%">
                                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#ff7815; color:#FFF">Detailed Information</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
            ...
            <div id="tab-parser">
                ...
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="skip_no_manufacturer">
                                <?php if ($skip_no_manufacturer) { ?>
                                <option value="1" selected="selected">Включить</option>
                                <option value="0">Отключить</option>
                                <?php } else { ?>
                                <option value="1">Включить</option>
                ...
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($update_manufacturers)) { ?>
                            <a class="button" href="<?php echo $update_manufacturers; ?>">Загрузить</a>
                            <a class="button" href="<?php echo $clear_manufacturers; ?>">Очистить</a>
                            <?php } ?>
                        </td>
                    </tr>
                </table>
                ...
                <table class="list">
                    ...
                    <tr>
                        ...
                        <td class="center" style="padding:5px; width:50px;">
                            <input class="supplier_category_checkbox checkbox" data-field="products" data-supplier-category-id="<?php echo $supplier_category['supplier_category_id']; ?>" id="products_<?php echo $supplier_category['supplier_category_id']; ?>" type="checkbox" name="products_<?php echo $supplier_category['supplier_category_id']; ?>" <? if ($supplier_category['products']){ ?>
                            checked="checked" <? } ?> value="1" />
                            <label for="products_<?php echo $supplier_category['supplier_category_id']; ?>"></label>
                        </td>
                        <td class="center" style="padding:5px; width:50px;">
                            <input class="supplier_category_checkbox checkbox" data-field="stocks" data-supplier-category-id="<?php echo $supplier_category['supplier_category_id']; ?>" id="stocks_<?php echo $supplier_category['supplier_category_id']; ?>" type="checkbox" name="stocks_<?php echo $supplier_category['supplier_category_id']; ?>" <? if ($supplier_category['stocks']){ ?>
                            checked="checked" <? } ?> value="1" />
                            <label for="stocks_<?php echo $supplier_category['supplier_category_id']; ?>"></label>
                        </td>
                        <td class="center" style="padding:5px; width:50px;">
                            <input class="supplier_category_checkbox checkbox" data-field="prices" data-supplier-category-id="<?php echo $supplier_category['supplier_category_id']; ?>" id="prices_<?php echo $supplier_category['supplier_category_id']; ?>" type="checkbox" name="prices_<?php echo $supplier_category['supplier_category_id']; ?>" <? if ($supplier_category['prices']){ ?>
                            checked="checked" <? } ?> value="1" />
            ...
            <div id="tab-manufacturers">
                <table class="list">
                    ...
                    <?php foreach ($supplier_manufacturers as $supplier_manufacturer) { ?>
                    <tr>
                        <td class="left" style="font-size:20px; width:400px;">
                            <?php echo $supplier_manufacturer['manufacturer']; ?>
                            <?php if ($supplier_manufacturer['manufacturer_full']) { ?>
                            <br/><small style="font-size:10px;"><?php echo $supplier_manufacturer['manufacturer_full']; ?></small>
                            <?php } ?>
                        </td>
                        <td class="center" style="padding:5px; width:50px;">
                            <input class="supplier_manufacturer_checkbox checkbox" data-field="products" data-supplier-manufacturer-id="<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" id="products_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" type="checkbox" name="products_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" <? if ($supplier_manufacturer['products']){ ?>
                            checked="checked" <? } ?> value="1" />
                            <label for="products_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>"></label>
                        </td>
                        <td class="center" style="padding:5px; width:50px;">
                            <input class="supplier_manufacturer_checkbox checkbox" data-field="stocks" data-supplier-manufacturer-id="<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" id="stocks_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" type="checkbox" name="stocks_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" <? if ($supplier_manufacturer['stocks']){ ?>
                            checked="checked" <? } ?> value="1" />
                            <label for="stocks_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>"></label>
                        </td>
                        <td class="center" style="padding:5px; width:50px;">
                            <input class="supplier_manufacturer_checkbox checkbox" data-field="prices" data-supplier-manufacturer-id="<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" id="prices_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" type="checkbox" name="prices_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>" <? if ($supplier_manufacturer['prices']){ ?>
                            checked="checked" <? } ?> value="1" />
                            <label for="prices_manufacturer_<?php echo $supplier_manufacturer['supplier_manufacturer_id']; ?>"></label>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
...
<script type="text/javascript">
    $('.supplier_manufacturer_checkbox').bind('change', function (){save_manufacturer($(this)); });

    function save_manufacturer(elem) {
        let supplier_manufacturer_id = elem.attr('data-supplier-manufacturer-id');
        ...
        $.ajax({
            url: 'index.php?route=sale/supplier/field_manufacturer&token=<?php echo $token; ?>',
            data: {
                supplier_manufacturer_id: supplier_manufacturer_id,
                field: field,
                value: value,
            },
            type: 'POST',
            beforeSend: function () {
                elem.removeClass('process, finished').addClass('process');
            },
            success: function () {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                if (field == 'attribute_id') {
                    $('#attribute_' + supplier_attribute_id).removeClass('process, finished').addClass('process');
                } else {
                    elem.removeClass('process, finished').addClass('process');
                }
            },
        ...
        $.ajax({
            ...
            beforeSend: function () {
                if (field == 'category_id') {
                    $('#category_' + supplier_category_id).removeClass('process, finished').addClass('process');
                } else {
                    elem.removeClass('process, finished').addClass('process');
                }
            },
