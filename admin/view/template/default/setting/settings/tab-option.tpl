<div id="tab-option">
    ...
    <table class="form">
        <tr>
            <td style="width:50%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#FF7815; color:#FFF"><?php echo $entry_catalog_limit; ?></span>
                </p>
                <input type="number" step="1" name="config_catalog_limit" value="<?php echo $config_catalog_limit; ?>" size="5"/>
            </td>
            <td style="width:50%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#FF7815; color:#FFF"><?php echo $entry_admin_limit; ?></span>
                </p>
    ...
    <table class="form">
        <tr>
            <td style="width:50%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Включить простое ценообразование</span>
                </p>
            ...
            <td style="width:50%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Наценка</span>
                </p>
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td>
                ...
                <a class="select_all" onclick="$(this).parent().find(':checkbox').attr('checked', true);">Выделить
                    всё</a><a class="remove_selection" onclick="$(this).parent().find(':checkbox').attr('checked', false);">Снять
                    выделение</a>
    ...
    <table class="form">
        ...
        <tr>
            <td>Статус после подверждения покупателем<span class="help">Статус, который будет установлен после подтверждения клиентом условий заказа по почте</span>
            </td>
        ...
        <tr>
            <td>Статус после подверждения покупателем c оплатой<span class="help">Статус, который будет установлен после подтверждения клиентом условий заказа по почте при условии, что заказ необходимо оплачивать!</span>
            </td>
        ...
        <tr>
            <td>Идентификаторы ОПЛАТЫ ПРИ ДОСТАВКЕ<span class="help">Идентификаторы способов оплат, при которых считается, что оплата будет произведена при доставке</span>
            </td>
            <td>
                <input name="config_confirmed_delivery_payment_ids" type="text" style="width:700px;" value="<? echo $config_confirmed_delivery_payment_ids; ?>">
            </td>
        </tr>
        <tr>
            <td>Оплаты - предоплаты!<span class="help">По этим идентификаторам определяется предоплата ли этот способ оплаты!</span>
            </td>
            <td>
                <textarea name="config_confirmed_prepay_payment_ids" style="width:700px;" rows="4"><? echo $config_confirmed_prepay_payment_ids; ?></textarea>
            </td>
        </tr>
        <tr>
            <td>Статус после частичной
                оплаты<span class="help">Статус, который будет установлен после частичной оплаты</span></td>
        ...
        <tr>
            <td>Статус после полной оплаты<span class="help">Статус, который будет установлен после полной оплаты</span>
            </td>
