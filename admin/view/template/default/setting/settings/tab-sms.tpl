			...
			<tr>
				...
				<td style="width:20%">
					<div>
						...
						<span class="help">Если включено, то режим отправки коротких уведомлений зависит от общей настройки статусов, в форме заказа текст редактировать невозможно</span>
					</div>		
				</td>
				...
				<td style="width:20%">
					<div>
						...
						<span class="help">Если включено, то в любом случае при отправке смс будет произведена отправка через viber</span>
					</div>	
				</td>						
			</tr>
		</table>
