<div id="tab-store">
        ...
        <tr>
            <td style="width:15%">
                <div style="padding:5px; background-color:pink;">
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#D69241; color:#FFF">Режим работы с Amazon</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#D69241; color:#FFF">Включить хранение данных в файлах</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#D69241; color:#FFF">Хайлоад режим</span>
                    </p>
            ...
            <td style="width:20%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#D69241; color:#FFF">Режим удаления ASIN</span>
                    </p>
                    <select name="config_rainforest_asin_deletion_mode">
                        ...
                        <option value="0" selected="selected">Отключить</option>
                        <? } ?>
                    </select> <a class="link_headr cache-button-good"><i class="fa fa-amazon" aria-hidden="true"></i>
                        ASIN</a> <a class="link_headr cache-button-bad"><i class="fa fa-amazon" aria-hidden="true"></i>
                        ASIN</a>
                    <br/>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#D69241; color:#FFF">Режим коррекции перевода</span>
                    </p>
                    <select name="config_rainforest_translate_edition_mode">
                        ...
                        <option value="0" selected="selected">Отключить</option>
                        <? } ?>
                    </select> <a class="link_headr cache-button-good"><i class="fa fa-refresh" aria-hidden="true"></i>
                        TRNSL</a>
                    <a class="link_headr cache-button-bad"><i class="fa fa-refresh" aria-hidden="true"></i> TRNSL</a>
                    <br/>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#D69241; color:#FFF">Режим редактирования вариантов</span>
                    </p>
                    <select name="config_rainforest_variant_edition_mode">
                        ...
                        <option value="0" selected="selected">Отключить</option>
                        <? } ?>
                    </select><a class="link_headr cache-button-good"><i class="fa fa-amazon" aria-hidden="true"></i> VAR</a>
                    <a class="link_headr cache-button-bad"><i class="fa fa-amazon" aria-hidden="true"></i> VAR</a>
                    <br/>
            ...
            <td style="width:15%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Статистика товаров и категорий в админке</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Загружать Ocfilter в карте товара</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Монитор cron на главной</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Удалять картинки</span>
                    </p>
            ...
            <td style="width:20%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Не удалять товары в заказах</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Не удалять товары на складе</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Фильтровать шаблоны акций</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Синхронизировать названия в заказах</span>
                    </p>
            ...
            <td width="20%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Рентабельность в заказах</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Закупка Amazon и рентабельность в остатках</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Список товаров с названиями в заказах</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Включить уведомления в админ-части</span>
                    </p>
    ...
    <table class="form">
        <tr>
            <td style="width:18%">
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#D69241; color:#FFF">CSV PP Без брендов</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Логика значений атрибутов</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Логика цен B2B</span>
                    </p>
            ...
            <td style="width:18%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Логика товаров-опций</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Логика HTML статусов</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Логика цен опций</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Логика цветовых групп</span>
                    </p>
            ...
            <td style="width:18%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Загрузки в товарах</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Опции товаров</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Смотрели вместе</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Описания в списках</span>
                    </p>
            ...
            <td style="width:18%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Recurring profiles</span>
                </p>
                ...
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Группы качества товаров</span>
                </p>
    ...
    <table class="form">
        <tr>
            <td style="width:18%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Single store mode</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF"><img src="<?php echo DIR_FLAGS_NAME; ?>de.png" title="de"/>Flags in admin</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Режим разработки</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF;">Монобрендовый магазин</span>
                    </p>
            ...
            <td style="width:18%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">В брендах только товары</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Обязательная цена</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Режим изоляции локалей</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Специальный фильтр логистики</span>
                    </p>
            ...
            <td style="width:20%">
                <div style="padding:10px; border:1px dashed grey;">
                    <div>
                        <p>
                            <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Отключать пустые категории</span>
                        </p>
                    ...
                    <div>
                        <p>
                            <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Включать не-пустые категории</span>
                        </p>
                ...
                <div style="padding:10px; border:1px dashed grey; margin-top:10px;">
                    ...
                    <div>
                        <p>
                            <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Восстанавливать скидку</span>
                        </p>
            ...
            <td style="width:18%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Отключить логику быстрого заказа</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Включить багфикс SimpleCheckout</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Включить "не перезванивать" в SimpleCheckout</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Вкл. "не перезванивать" если все в нал.</span>
                    </p>
    ...
    <table class="form">
        <tr>
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Счетчик количества</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Отдельная табличка нефильтруемых атрибутов</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Разрешить скачивание файлов</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Прятать артикул в карте</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Подменять SKU/MODEL на код товара на выводе</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Добавлять префикс к коду товара/SKU при использовании подмены</span>
                </p>
        ...
        <tr>
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Группа атрибутов "особенности"</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Группа атрибутов "Спецификации"</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Группа атрибутов по-умолчанию</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Группа атрибутов "Габариты"</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Название атрибутов - особенностей</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Название атрибутов - cпецификаций</span>
                </p>
        ...
        <tr>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Второй уровень подкатегорий в категориях</span>
                </p>
            ...
            <td style="width:15%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Товары только в крайних категориях</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Убрать товары только с уровня 0</span>
                    </p>
            ...
            <td style="width:15%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Отображать подкатегории во всех категориях</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Лимит подкатегорий второго уровня</span>
                    </p>
            ...
            <td style="width:15%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Отображать только товары с полной инфой</span>
                    </p>
            ...
            <td style="width:15%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Сортировка по-умолчанию</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Порядок по-умолчанию</span>
                    </p>
            ...
            <td style="width:15%">
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Логика раздела "все скидки"</span>
                    </p>
                ...
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">ID категории товаров со скидками</span>
                    </p>
                    <input type="number" name="config_special_category_id" value="<?php echo $config_special_category_id; ?>" size="50" style="width:90px;"/>
                </div>
                <div>
                    <p>
                        <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Единая логика скидок</span>
                    </p>
    ...
    <table class="form">
        <tr>
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Новинки без new = 1</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Новинки без Amazon</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Интервал добавления</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#7F00FF; color:#FFF">Интервал добавления длинный</span>
                </p>
    ...
    <table class="form">
        <tr>
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Разрешить отзывы</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Количество "лучших отзывов" в карте товара</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Без модерации</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Уведомление на мейл</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Можно ли редактировать в ЛК</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Модерация после редактирования</span>
                </p>
        ...
        <tr>
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Поле "недостатки"</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Поле "достоинства"</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Добавлять вложения</span>
                </p>
            ...
            <td style="width:15%">
                <p>
                    <span class="status_color" style="display:inline-block; padding:3px 5px; background:#cf4a61; color:#FFF">Включить капчу</span>
                </p>
