      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="name" style="width:400px;" value="<?php echo $name; ?>" />
              <?php if ($error_name) { ?>
        ...
        <table id="route" class="list">
          ...
          <tbody id="route-row<?php echo $route_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" name="layout_route[<?php echo $route_row; ?>][route]" value="<?php echo $layout_route['route']; ?>" /></td>
			   <td class="left"><input type="text" name="layout_route[<?php echo $route_row; ?>][template]" value="<?php echo $layout_route['template']; ?>" style="width:300px;" /></td>
              <td class="right"><a onclick="$('#route-row<?php echo $route_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $route_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="3"></td>
              <td class="right"><a onclick="addRoute();" class="button"><?php echo $button_add_route; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addRoute() {
	...
	html += '    <td class="left"><input type="text" name="layout_route[' + route_row + '][template]" value="" style="width:300px;" /></td>';
	html += '    <td class="right"><a onclick="$(\'#route-row' + route_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
