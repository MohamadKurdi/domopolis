					...
					<table class="form">
						...
						*/ ?>
						...
						<tr>
							...
							<td>
								<input class="checkbox" type="checkbox" id="unavailable" name="yandex_yml_unavailable" value="1" <?php echo ($yandex_yml_unavailable ? 'checked="checked"' : ''); ?> />
							...
							<?php foreach ($categories as $category) { ?>
								...
								<div class="<?php echo $class; ?>">
									<?php if (in_array($category['category_id'], $yandex_yml_categories)) { ?>
										<input id="yandex_yml_categories[]_<?php echo $category['category_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_categories[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
										<label for="yandex_yml_categories[]_<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></label>
										<?php } else { ?>
										<input id="yandex_yml_categories[]_<?php echo $category['category_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_categories[]" value="<?php echo $category['category_id']; ?>" />
										<label for="yandex_yml_categories[]_<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></label>
									<?php } ?>
						...
						<td><div class="scrollbox" style="height: 200px;">
							...
							<div class="<?php echo $class; ?>">
								<?php if (in_array($manufacturer['manufacturer_id'], $yandex_yml_manufacturers)) { ?>
									<input id="yandex_yml_manufacturers[]_<?php echo $manufacturer['manufacturer_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_manufacturers[]" value="<?php echo $manufacturer['manufacturer_id']; ?>" checked="checked" />
									<label for="yandex_yml_manufacturers[]_<?php echo $manufacturer['manufacturer_id']; ?>"><?php echo $manufacturer['name']; ?></label>
									<?php } else { ?>
									<input id="yandex_yml_manufacturers[]_<?php echo $manufacturer['manufacturer_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_manufacturers[]" value="<?php echo $manufacturer['manufacturer_id']; ?>" />
									<label for="yandex_yml_manufacturers[]_<?php echo $manufacturer['manufacturer_id']; ?>"><?php echo $manufacturer['name']; ?></label>
								<?php } ?>
							</div>
							<?php } ?>
				...
				<table class="form">
						...
						<td><div class="scrollbox" style="height: 200px;">
							...
							<div class="<?php echo $class; ?>">
								<?php if (in_array($attribute['attribute_id'], $yandex_yml_attributes)) { ?>
									<input id="yandex_yml_attributes[]_<?php echo $attribute['attribute_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_attributes[]" value="<?php echo $attribute['attribute_id']; ?>" checked="checked" />
									<label for="yandex_yml_attributes[]_<?php echo $attribute['attribute_id']; ?>"><?php echo $attribute['name']; ?></label>
									<?php } else { ?>
									<input id="yandex_yml_attributes[]_<?php echo $attribute['attribute_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_attributes[]" value="<?php echo $attribute['attribute_id']; ?>" />
									<label for="yandex_yml_attributes[]_<?php echo $attribute['attribute_id']; ?>"><?php echo $attribute['name']; ?></label>
								<?php } ?>
							</div>
							<?php } ?>
					...
					<tr>
						...
						<tr>
							...
							<tr>
								...
								<tr>
									...
									<td><input id="yandex_yml_attr_vs_description" class="checkbox" type="checkbox" name="yandex_yml_attr_vs_description" <?php echo ($yandex_yml_attr_vs_description ? ' checked="checked"' : ''); ?>/>
									<label for="yandex_yml_attr_vs_description"></label>
									</td>
								</tr>
								<tr>
									<td><?php echo $entry_product_rel; ?></td>
									<td><input id="yandex_yml_product_rel" class="checkbox" type="checkbox" name="yandex_yml_product_rel" <?php echo ($yandex_yml_product_rel ? ' checked="checked"' : ''); ?>/>
									<label for="yandex_yml_product_rel"></label>
									</td>
								</tr>
								<tr>
									<td><?php echo $entry_product_accessory; ?></td>
									<td><input id="yandex_yml_product_accessory" class="checkbox" type="checkbox" name="yandex_yml_product_accessory" <?php echo ($yandex_yml_product_accessory ? ' checked="checked"' : ''); ?>/>
									<label for="yandex_yml_product_accessory"></label>
									</td>
								</tr>
							</table>
						</div>
						<div id="tab-tailor">
										...
										<?php foreach ($options as $option) { ?>
											...
											<div class="<?php echo $class; ?>">
												<?php if (in_array($option['option_id'], $yandex_yml_color_options)) { ?>
													<input id="yandex_yml_color_options[]_<?php echo $option['option_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_color_options[]" value="<?php echo $option['option_id']; ?>" checked="checked" />
													<label for="yandex_yml_color_options[]_<?php echo $option['option_id']; ?>"><?php echo $option['name']; ?></label>
													<?php } else { ?>
													<input id="yandex_yml_color_options[]_<?php echo $option['option_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_color_options[]" value="<?php echo $option['option_id']; ?>" />
													<label for="yandex_yml_color_options[]_<?php echo $option['option_id']; ?>"><?php echo $option['name']; ?></label>
												<?php } ?>
											</div>
										<?php } ?>
										...
										<?php foreach ($options as $option) { ?>
											...
											<div class="<?php echo $class; ?>">
												<?php if (in_array($option['option_id'], $yandex_yml_size_options)) { ?>
													<input id="yandex_yml_size_options[]_<?php echo $option['option_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_size_options[]" value="<?php echo $option['option_id']; ?>" checked="checked" />
													<label for="yandex_yml_size_options[]_<?php echo $option['option_id']; ?>"><?php echo $option['name']; ?></label>
													<?php } else { ?>
													<input id="yandex_yml_size_options[]_<?php echo $option['option_id']; ?>" class="checkbox" type="checkbox" name="yandex_yml_size_options[]" value="<?php echo $option['option_id']; ?>" />
													<label for="yandex_yml_size_options[]_<?php echo $option['option_id']; ?>"><?php echo $option['name']; ?></label>
												<?php } ?>
							...
							<td><input type="text" name="generator_shop_id" id="generator_shop_id" value="0" />
							</td>		
							</tr>
							<tr>
							<td>
							...
							<td>
							<input type="text" name="generator_currency_code" id="generator_currency_code" value="RUB" />&nbsp;&nbsp;		
							...
							$('#generator_result').load('<? echo HTTP_CATALOG . '' . DIR_EXPORT_NAME . 'yandex_yml.php?just_return_filename=true' ?>&store_id='+$('#generator_shop_id').val()+'&currency='+$('#generator_currency_code').val());						
							});	
							...
							$('#generator_result').load('<? echo HTTP_CATALOG . '' . DIR_EXPORT_NAME . 'yandex_yml.php' ?>?store_id='+$('#generator_shop_id').val()+'&currency='+$('#generator_currency_code').val());
