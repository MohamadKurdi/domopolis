        ...
        <table id="zone-to-geo-zone" class="list">
          ...
          <tbody id="zone-to-geo-zone-row<?php echo $zone_to_geo_zone_row; ?>">
            <tr>
              ...
              <td class="right"><a onclick="$('#zone-to-geo-zone-row<?php echo $zone_to_geo_zone_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          ...
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="right"><a onclick="addGeoZone();" class="button"><?php echo $button_add_geo_zone; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
...
function addGeoZone() {
	...
	html += '<td class="right"><a onclick="$(\'#zone-to-geo-zone-row' + zone_to_geo_zone_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
	html += '</tr>';
	html += '</tbody>';
