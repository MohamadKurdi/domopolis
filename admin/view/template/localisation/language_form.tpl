            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <div style="width:35%; float:left; padding-right:10px;">
                    <table class="form">
                        ...
                        <tr>
                            <td><span class="required">*</span> HREFLANG</td>
                            <td><input type="text" name="hreflang" value="<?php echo $hreflang; ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>Свитчер</td>
                ...
                <div style="width:60%; float:right;  padding-left:10px;">
                    <i class="fa fa-info-circle"></i> Интеллектуальный высокотехнологичный перевод.<br />
                    <code>Формат ввода: Текст::Перевод. HTML не учитывается. Например, Подарки::Подарунки</code>
                    <textarea name="fasttranslate" cols="100" rows="30"><?php echo $fasttranslate;?></textarea>
                </div>
            </form>
        </div>
    </div>
