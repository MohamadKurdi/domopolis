            ...
            <tr>
              ...
              <?php } else { ?>
                ...
                <?php } else { ?>
                  ...
                  <td class="left">HrefLang</td>
                  <td class="left">Статус</td>
                  <td class="left">Фронт</td>
                    ...
                    <?php foreach ($languages as $language) { ?>
                      <tr>
                        ...
                        <?php } else { ?>
                          ...
                          <?php } ?></td>
                          <td class="left"><?php echo $language['language_id']; ?> : <?php echo $language['name']; ?></td>
                          <td class="left"><?php echo $language['code']; ?></td>
                          <td class="left"><?php echo $language['urlcode']; ?></td>
                          <td class="left"><?php echo $language['hreflang']; ?></td>
