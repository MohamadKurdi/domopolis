        ...
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
			  ...
			  <td class="right"><input type="text" name="bestseller_module[<?php echo $module_row; ?>][ignore_brands]" value="<?php echo $module['ignore_brands']; ?>" size="20" /></td>
