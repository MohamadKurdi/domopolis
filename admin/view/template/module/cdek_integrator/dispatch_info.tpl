<div class="heading dispatch-info">
	...
	<div class="buttons">
		<a href="<?php echo $sync; ?>" class="button sync"><?php echo $button_sync; ?></a>
		<a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a>
		<nobr class="help sync">Последняя cинхронизация: <strong><?php echo $last_exchange; ?></strong></nobr>
	</div>
</div>
<div class="content">
	<table class="form">
