      ...
      <div id="settings" class="htab-content">
        <div class="tab-body table-form">
          ...
          <div class="row">
            ...
            <div class="col-sm-5">
              <div class="wrap-5">
                  <select id="d_social_login_settings_customer_group" name="d_social_login_settings[customer_group]">
          ...
          <?php foreach($providers as $key => $provider) { ?>
            ...
            <div class="row">
              ...
              <div class="col-sm-5">
                <div class="wrap-5">
                  <input type="text" name="d_social_login_settings[providers][<?php echo $key; ?>][scope]" value="<?php echo $provider['scope']; ?>" />          
                </div>
              </div>
            </div>
            <?php } ?>
