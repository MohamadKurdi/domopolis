			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				...
				<div id="tab-product">
					...
					<table class="form">
						<tr>
							...
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_flush_product" name="exchange1c_flush_product" <?php echo ($exchange1c_flush_product == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_flush_product"></label>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_flush_category" name="exchange1c_flush_category" <?php echo ($exchange1c_flush_category == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_flush_category"></label>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_flush_manufacturer" name="exchange1c_flush_manufacturer" <?php echo ($exchange1c_flush_manufacturer == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_flush_manufacturer"></label>
							</td>
						</tr>
						
						<tr>
							<td><?php echo $entry_flush_attribute; ?></td>
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_flush_attribute" name="exchange1c_flush_attribute" <?php echo ($exchange1c_flush_attribute == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_flush_attribute"></label>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_flush_quantity" name="exchange1c_flush_quantity" <?php echo ($exchange1c_flush_quantity == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_flush_quantity"></label>
							</td>
						</tr>
						
						<tr>
							<td><?php echo $entry_fill_parent_cats; ?></td>
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_fill_parent_cats" name="exchange1c_fill_parent_cats" <?php echo ($exchange1c_fill_parent_cats == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_fill_parent_cats"></label>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_seo_url" name="exchange1c_seo_url" <?php echo ($exchange1c_seo_url == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_seo_url"></label>
							</td>
						</tr>
						
						<tr>
							<td><?php echo $entry_relatedoptions; ?></td>
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_relatedoptions" name="exchange1c_relatedoptions" <?php echo ($exchange1c_relatedoptions == 1)? 'checked' : ''; ?>>
								<label for="exchange1c_relatedoptions"></label>
								<span class="help"><?php echo $entry_relatedoptions_help; ?></span>
							</td>
						</tr>
						
						<tr>
							<td><?php echo $entry_full_log; ?></td>
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_full_log" name="exchange1c_full_log" <?php echo ($exchange1c_full_log == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_full_log"><?php echo $entry_full_log; ?></label>
							</td>
						</tr>
						
						<tr>
							<td><?php echo $entry_apply_watermark; ?></td>
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_apply_watermark" name="exchange1c_apply_watermark" <?php echo ($exchange1c_apply_watermark == 1)? 'checked' : ''; ?>>
								<label for="exchange1c_apply_watermark"></label>
				...
				<div id="tab-order">
					<table class="form">
						...
						<tr>
							<td><?php echo $entry_order_notify; ?></td>
							<td>
								<input class="checkbox" type="checkbox" value="1" id="exchange1c_order_notify" name="exchange1c_order_notify" <?php echo ($exchange1c_order_notify == 1)? 'checked' : ''; ?>>
							<label for="exchange1c_order_notify"></label>
							</td>
						</tr>
