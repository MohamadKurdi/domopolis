			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				...
				<div id="tab-html">
					...
					<div id="tab-content-<?php echo $content_row; ?>" class="vtabs-content" rel="<?php echo $block_id; ?>">
						<div id="tabs-block-<?php echo $block_id; ?>" class="htabs" style="height: 21px;">
								...
								<table class="form config">
									<tbody>
										...
										<tr class="parent html-block-theme">
											<td><?php echo $entry_use_theme; ?></td>
											<td><input id="html-block-<?php echo $block_id; ?>-theme" type="checkbox" class="checkbox slider" name="html_block_<?php echo $block_id; ?>[theme]" <?php echo isset($content['theme']) ? 'checked="checked"' : ''; ?>  />
											<label for="html-block-<?php echo $block_id; ?>-theme"></label>
											</td>
										</tr>
										<tr>
										...
										<tr class="parent">
											...
											<td><input id="html-block-<?php echo $block_id; ?>-style" type="checkbox" class="checkbox slider" name="html_block_<?php echo $block_id; ?>[style]" <?php echo isset($content['style']) ? 'checked="checked"' : ''; ?>  value="1" />
											<label for="html-block-<?php echo $block_id; ?>-style"></label>
											</td>
										</tr>
										<tr>
											<td colspan="2" class="include">
										...
										<tr>
											...
											<td><input id="html-block-<?php echo $block_id; ?>-reset" class="checkbox" type="checkbox" name="html_block_<?php echo $block_id; ?>[reset]" value="1" />
												<label for="html-block-<?php echo $block_id; ?>-reset"></label>
												</td>
										</tr>
									</tbody>
								</table>
								...
								<table class="form">
									<tbody>
										<tr>
											...
											<td>
											<input id="html-block-<?php echo $block_id; ?>-use-php" class="checkbox" type="checkbox" name="html_block_<?php echo $block_id; ?>[use_php]" <?php echo isset($content['use_php']) ? 'checked="checked"' : ''; ?>  />
											<label for="html-block-<?php echo $block_id; ?>-use-php"></label>
											</td>
										</tr>
										<tr>
											<td><?php echo $entry_cache; ?></td>
											<td>
											<input id="html-block-<?php echo $block_id; ?>-use-cache" class="checkbox" type="checkbox" name="html_block_<?php echo $block_id; ?>[use_cache]" <?php echo isset($content['use_cache']) ? 'checked="checked"' : ''; ?>  />
											<label for="html-block-<?php echo $block_id; ?>-use-cache"></label>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="scrollbox">
													...
													<input id="<?php echo $store['store_id']; ?>" class="checkbox" type="checkbox" name="html_block_<?php echo $block_id; ?>[store][]" value="<?php echo $store['store_id']; ?>" <?php  if (isset($content['store']) && in_array($store['store_id'], $content['store'])) echo 'checked="checked"'; ?> />
														<label for="<?php echo $store['store_id']; ?>"><?php echo $store['name']; ?></label>
