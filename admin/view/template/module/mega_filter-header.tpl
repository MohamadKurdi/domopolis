	...
	<div class="mega-filter-pro">	
		...
		<div class="box">
			<div class="heading order_head">
				...
				<div class="buttons">
					<a id="mf-save-form" class="button"><i class="glyphicon glyphicon-ok"></i> <?php echo $button_save; ?></a>
					<a href="<?php echo $back; ?>" class="button"><i class="glyphicon glyphicon-chevron-left"></i> <?php echo $button_back; ?></a>
				</div>
			</div>
