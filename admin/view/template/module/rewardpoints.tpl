				...
				<td><div class="scrollbox">
					...
					<?php foreach ($order_statuses as $order_status) { ?>
						...
						<div class="<?php echo $class; ?>">
							<input id="rewardpoints_completed_orders[]_<?php echo $order_status['order_status_id']; ?>" class="checkbox" type="checkbox" name="rewardpoints_completed_orders[]" value="<?php echo $order_status['order_status_id']; ?>" <?php echo (in_array($order_status['order_status_id'], $rewardpoints_completed_orders)) ? 'checked="checked"' : ''; ?> />
							<label for="rewardpoints_completed_orders[]_<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></label>
						</div>
					<?php } ?>
				</div>
			...
			<tr>
				...
				<td><div class="scrollbox">
					...
					<?php foreach ($order_statuses as $order_status) { ?>
						<?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
						<div class="<?php echo $class; ?>">
							<input id="rewardpoints_cancelled_orders[]_<?php echo $order_status['order_status_id']; ?>" class="checkbox" type="checkbox" name="rewardpoints_cancelled_orders[]" value="<?php echo $order_status['order_status_id']; ?>" <?php echo (in_array($order_status['order_status_id'], $rewardpoints_cancelled_orders)) ? 'checked="checked"' : ''; ?> />
							<label for="rewardpoints_cancelled_orders[]_<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></label>
						</div>
					<?php } ?>
				</div>
				<a class="select_all" onclick="$(this).parent().find(':checkbox').attr('checked', true);">Выделить всё</a><a class="remove_selection" onclick="$(this).parent().find(':checkbox').attr('checked', false);">Снять выделение</a>
				...
				<tr>
					...
					<td><div class="scrollbox">
						...
						<?php foreach ($order_statuses as $order_status) { ?>
							<?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
							<div class="<?php echo $class; ?>">
								<input id="rewardpoints_email_status[]_<?php echo $order_status['order_status_id']; ?>" class="checkbox" type="checkbox" name="rewardpoints_email_status[]" value="<?php echo $order_status['order_status_id']; ?>" <?php echo (in_array($order_status['order_status_id'], $rewardpoints_email_status)) ? 'checked="checked"' : ''; ?> />
								<label for="rewardpoints_email_status[]_<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></label>
							</div>
						<?php } ?>
					</div>
					<a class="select_all" onclick="$(this).parent().find(':checkbox').attr('checked', true);">Выделить всё</a><a class="remove_selection" onclick="$(this).parent().find(':checkbox').attr('checked', false);">Снять выделение</a>
