        ...
        <table id="module" class="list">
          ...
          <?php foreach ($modules as $module) { ?>
            <tbody id="module-row<?php echo $module_row; ?>">
              <tr>
                <td class="left"><select name="selected_category_module[<?php echo $module_row; ?>][layout_id]">
...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="selected_category_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
   html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
 <?php } ?>
 html += '    </select></td>';
 html += '    <td class="left"><select name="selected_category_module[' + module_row + '][position]">';
