					...
					<?php foreach ($modules as $module) { ?>
						<tbody id="module-row<?php echo $module_row; ?>">
							<tr>
								...
								<td class="left">
									<input type="text" name="slideshow_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
								...
								<td class="left">
									<input type="text" name="slideshow_module[<?php echo $module_row; ?>][width_sm]" value="<?php echo $module['width_sm']; ?>" size="3" />
									<input type="text" name="slideshow_module[<?php echo $module_row; ?>][height_sm]" value="<?php echo $module['height_sm']; ?>" size="3"/>								
								</td>								
...
function addModule() {	
	...
	html += '    <td class="left"><input type="text" name="slideshow_module[' + module_row + '][width_sm]" value="" size="3" /> <input type="text" name="slideshow_module[' + module_row + '][height_sm]" value="" size="3" /></td>';
