  ...
  <div class="content">
    ...
    <table class="form">
        ...
        <tr>
          ...
          <td>
            <input id="vk_export_album_only" class="checkbox" type="checkbox" name="vk_export_album_only" value="1" <?php echo $vk_export_album_only == 1 ? 'checked="checked"' : ''; ?> />
         <label for="vk_export_album_only"></label>
		 </td>
        </tr> 
        <tr>
          <td><?php echo $entry_mode_desc ?></td>
          <td>
            <input id="vk_export_mode_desc" class="checkbox" type="checkbox" name="vk_export_mode_desc" value="1" <?php echo $vk_export_mode_desc == 1 ? 'checked="checked"' : ''; ?> />
          <label for="vk_export_mode_desc"></label>
		  </td>
        </tr>  
        <tr>
        ...
        <tr>
          ...
          <td>
            <input id="vk_export_mode_comment" class="checkbox" type="checkbox" name="vk_export_mode_comment" value="1" <?php echo $vk_export_mode_comment == 1 ? 'checked="checked"' : ''; ?> />
          <label for="vk_export_mode_comment"></label>
		  </td>
        </tr>  
        <tr>
        ...
        <tr>
          ...
          <td>
            <input id="vk_export_column_model" class="checkbox" type="checkbox" name="vk_export_column_model" value="1" <?php echo $vk_export_column_model == 1 ? 'checked="checked"' : ''; ?> /> 
			<label for="vk_export_column_model"><?php echo $text_model; ?></label><br><br>
            <input id="vk_export_column_price" class="checkbox" type="checkbox" name="vk_export_column_price" value="1" <?php echo $vk_export_column_price == 1 ? 'checked="checked"' : ''; ?> /> 
			<label for="vk_export_column_price"><?php echo $text_price; ?></label><br><br>
            <input id="vk_export_column_quantity" class="checkbox" type="checkbox" name="vk_export_column_quantity" value="1" <?php echo $vk_export_column_quantity == 1 ? 'checked="checked"' : ''; ?> /> 
			<label for="vk_export_column_quantity"><?php echo $text_quantity; ?></label><br><br>
            <input id="vk_export_column_status" class="checkbox" type="checkbox" name="vk_export_column_status" value="1" <?php echo $vk_export_column_status == 1 ? 'checked="checked"' : ''; ?> /> 
			<label for="vk_export_column_status"><?php echo $text_status; ?></label><br><br>
            <input id="vk_export_column_date_added" class="checkbox" type="checkbox" name="vk_export_column_date_added" value="1" <?php echo $vk_export_column_date_added == 1 ? 'checked="checked"' : ''; ?> />
			<label for="vk_export_column_date_added"><?php echo $text_date_added; ?></label><br>
          </td>
        </tr>
        <tr>
    ...
    <div id="tab2" style="display:none;">
        ...
        <tr>
          ...
          <td>
           <input id="vk_export_autoexport" class="checkbox" type="checkbox" name="vk_export_autoexport" value="1" <?php echo $vk_export_autoexport == 1 ? 'checked="checked"' : ''; ?> />
           <label for="vk_export_autoexport"></label>
		  </td>
        </tr>  
        <tr>
        ...
        <tr>
          ...
          <td>
            <input id="vk_export_only_instock" class="checkbox" type="checkbox" name="vk_export_only_instock" value="1" <?php echo $vk_export_only_instock == 1 ? 'checked="checked"' : ''; ?> />
          <label for="vk_export_only_instock"></label>
		  </td>
        </tr>  
        <tr>
          <td><?php echo $entry_delete_out_of_stock ?></td>
          <td>
            <input id="vk_export_cron_delete_out_of_stock" class="checkbox type="checkbox" name="vk_export_cron_delete_out_of_stock" value="1" <?php echo $vk_export_cron_delete_out_of_stock == 1 ? 'checked="checked"' : ''; ?> />
			 <label for="vk_export_cron_delete_out_of_stock"></label>
          </td>
        </tr>  
        <tr>
          <td><?php echo $entry_export_only_enabled ?></td>
          <td>
            <input id="vk_export_only_enabled" class="checkbox type="checkbox" name="vk_export_only_enabled" value="1" <?php echo $vk_export_only_enabled == 1 ? 'checked="checked"' : ''; ?> />
			<label for="vk_export_only_enabled"></label>
          </td>
        </tr>  
        <tr>
		<tr>
          ...
          <td>
            <input id="vk_export_cron_delete_disabled" class="checkbox type="checkbox" name="vk_export_cron_delete_disabled" value="1" <?php echo $vk_export_cron_delete_disabled == 1 ? 'checked="checked"' : ''; ?> />
         <label for="vk_export_cron_delete_disabled"></label>
		 </td>
        </tr> 
        <tr>
          <td><?php echo $entry_export_albums_only_specials ?></td>
          <td>
            <input id="vk_export_albums_only_specials" class="checkbox type="checkbox" name="vk_export_albums_only_specials" value="1" <?php echo $vk_export_albums_only_specials == 1 ? 'checked="checked"' : ''; ?> />
          <label for="vk_export_albums_only_specials"></label>
		 </td>
        </tr>  
        <tr>
          <td><?php echo $entry_export_wall_only_specials ?></td>
          <td>
            <input id="vk_export_wall_only_specials" class="checkbox type="checkbox" name="vk_export_wall_only_specials" value="1" <?php echo $vk_export_wall_only_specials == 1 ? 'checked="checked"' : ''; ?> />
         <label for="vk_export_wall_only_specials"></label>
		 </td>
        </tr>  
        <tr>
          <td><?php echo $entry_export_wall_unique ?></td>
          <td>
            <input id="vk_export_wall_unique" class="checkbox" type="checkbox" name="vk_export_wall_unique" value="1" <?php echo $vk_export_wall_unique == 1 ? 'checked="checked"' : ''; ?> />
          <label for="vk_export_wall_unique"></label>
		  </td>
        </tr>  
        <tr>
        ...
        <tr>
          ...
          <td><div class="scrollbox">
              ...
              <div class="<?php echo $class; ?>">
                ...
                <input id="category_<?php echo $category['category_id']; ?>" class="checkbox" type="checkbox" name="vk_export_autoexport_category[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                <label for="category_<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></label>
                <?php } else { ?>
                <input id="category_<?php echo $category['category_id']; ?>" class="checkbox" type="checkbox" name="vk_export_autoexport_category[]" value="<?php echo $category['category_id']; ?>" />
                <label for="category_<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></label>
                <?php } ?>
              </div>
              <?php } ?>
        ...
        <tr>
          ...
          <td><div class="scrollbox">
              ...
              <div class="<?php echo $class; ?>">
                ...
                <input id="category_wall_<?php echo $category['category_id']; ?>" class="checkbox" type="checkbox" name="vk_export_autoexport_category_wall[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                <label for="category_wall_<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></label>
                <?php } else { ?>
                <input id="category_wall_<?php echo $category['category_id']; ?>" class="checkbox" type="checkbox" name="vk_export_autoexport_category_wall[]" value="<?php echo $category['category_id']; ?>" />
                <label for="category_wall_<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></label>
                <?php } ?>
              </div>
              <?php } ?>
