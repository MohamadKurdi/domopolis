                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <label class="col-sm-4" for="input-merchant" style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;width: 100%;">
                                <span data-toggle="tooltip" title=""><?php echo $entry_redirect ;?></span>
                            </label>
                      ...
                      <div class="col-xs-12">
                         ...
                         <div class="col-xs-12">
                            <label class="col-sm-4" for="input-hold" style="position:absolute; margin-left: 6px; font-size: 14px; margin-top: 1px; font-weight:300;">
                                <span data-toggle="tooltip" title=""><?php echo $entry_hold ;?></span>
                            </label>
                            <select name="mono_hold_mode" id="input-hold" class="mono-select">
                                <?php if($mono_hold_mode){ ?>
                                    <option class="mono-option" value="1" selected="selected"><?php echo $text_enabled ;?></option>
                                    <option class="mono-option" value="0"><?php echo $text_disabled ;?></option>
                               <?php } else{ ?>
                                <option class="mono-option" value="1"><?php echo $text_enabled ;?></option>
