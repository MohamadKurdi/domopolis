...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
	  ...
	  <div class="htabs" id="tabs" style="margin-bottom:25px;">
		<a style="width:50px;" href="#tab-general" style="display: inline;" <?php if( empty($current_store_id) ) { ?> class="selected" <?php } ?> 
		 onclick="$('#current_store_id').attr('value', '0');" 
		><?php echo $tab_general; ?></a>
		<?php foreach($stores as $store) { ?>
			<a style="width:50px;" href="#tab-general-<?php echo $store['store_id']; ?>" 
