					...
					<table class="form">
						...
						<tr style="border-bottom:1px dashed gray">
							...
							<td colspan="3">	
								...
								<br />
								<span class="help">Если есть текстовое описание акции, и она привязана, то в каталоге на товарах, на которые действует промокод, будет выводиться пояснение и лейбл из этой акции</span>	
							</td>		
						</tr>
