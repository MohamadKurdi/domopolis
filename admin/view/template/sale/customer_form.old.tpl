		  ...
		  <script type="text/javascript">
            ...
            <table class="form">
              ...
              <tr>
			   ...
			   <tr>
                <td><span class="required"></span> Комментарий / описание </td>				
                <td><textarea name="customer_comment" rows="5" cols="100"><? echo $customer_comment; ?></textarea>
				</td>
              </tr>
			  <tr>
                <td>Дисконтная карта</td>
                <td><input type="text" name="discount_card" value="<?php echo $discount_card; ?>" />
                  </td>
              </tr>
              <tr>
