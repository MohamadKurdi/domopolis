					...
					<tr class="filter">
						...
						<td colspan="2" class="input_aling">
							...
							<div style="margin-top:8px;">
								...
								<label for="checkbox_12" style="color:#005BBB;"><i class="fa fa-bus" style="padding: 3px 5px;background-color: #005BBB;color: #FFF;"></i>&nbsp;<img src="view/image/flags/ua.png" />&nbsp;Логистика через Украину</label>
							</div>
						</td>
