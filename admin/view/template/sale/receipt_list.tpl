...
<div class="well">
   ...
   <div class="col-sm-3">
      <div class="form-group">
         <label class="control-label" for="input-order-id">Замовлення</label>
...
<tbody>
   <?php if ($receipts) { ?>
      <?php foreach ($receipts as $receipt) { ?>
         ...
         <td class="text-left">
            <a href="<?php echo $receipt['order_info_link']; ?>"  > Заказ <?php echo $receipt['order_id']; ?></a>
            <br>
            Доставка: <?php echo $receipt['shipping_method']; ?> <br>
            Оплата: <?php echo $receipt['payment_method']; ?> <br> 
            Код: <?php echo $receipt['payment_code']; ?> <br>
