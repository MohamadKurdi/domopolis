        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right"><?php echo $voucher['amount']; ?> (<? echo $voucher['curr']; ?>)</td>
              ...
              <td class="right"><a class="button" onclick="sendVoucher('<?php echo $voucher['voucher_id']; ?>');"><i class="fa fa-paper-plane"></i></a> 
