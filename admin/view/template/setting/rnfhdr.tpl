...
<?php } else { ?>
	...
	<?php if ($message == 'ZERO_CREDITS_AND_OVERAGE_IS_USED_NOW') { ?>
		...
		<span style="color:#FF9243; font-size:18px; font-weight: 700;"><i class="fa fa-exclamation-triangle"></i>
	...
	<?php } else { ?>
		<span style="color:#cf4a61; font-size:18px; font-weight: 700;"><i class="fa fa-exclamation-triangle"></i>
