				...
				<div id="tab-data">
					<table class="form">
						<tbody>
							...
							<input type="hidden" id="cdek_use_region" name="cdek_use_region" value="0">
							<tr>
								<td><label for="cdek-use-postcode"><?php echo $entry_use_postcode; ?></label></td>
								<td>
									<select id="cdek-use-postcode" name="cdek_use_postcode">
										<?php foreach($boolean_variables as $key => $variable) { ?>
