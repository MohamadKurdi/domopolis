...
class ControllerAccountReturn extends Controller { 
	...
	public function index() {
		...
		$return_total = $this->model_account_return->getTotalReturns($show_to_supplier = false);

		$results = $this->model_account_return->getReturns(($page - 1) * 10, 10, $show_to_supplier = false);
