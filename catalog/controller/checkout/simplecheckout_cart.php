    ...
    */
    ...
    class ControllerCheckoutSimpleCheckoutCart extends SimpleController {
        ...
        public function index() {
            ...
            $this->_templateData['current_step'] = 1;
            if (!empty($this->request->post['next_step']) && (int)$this->request->post['next_step'] > 1){
                $this->_templateData['current_step'] = $this->request->post['next_step'];
            }
            ...
            $this->_templateData['entry_reward'] = sprintf($this->language->get('entry_reward'), $max_points_to_use);
