			...
			foreach ($extensions as $extension) {
				...
				if ($modules) {
					...
					foreach ($modules as $module) {
						...
						if ((( in_array( $layout_id, $module['layout_id'] ) || in_array( '-1', $module['layout_id'] ) || in_array( $all_pages_layout_id , $module['layout_id'] ) ) || $module['layout_id'] == $all_pages_layout_id) && $module['position'] == 'column_left' && $module['status']) {												
