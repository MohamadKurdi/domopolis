	...
	class ControllerModuleCustomerMenu extends Controller {
		...
		public function login(){
			...
			if ($this->data['success']){
				...
				$this->data['link_name'] = $this->url->link('account/simpleedit', '');
				$this->data['text_name'] = $this->language->get('text_name');
				$this->data['user_name'] = $this->customer->getFirstName().' '.$this->customer->getLastName();
				
				$this->data['link_discount'] = $this->url->link('account/rewards', '');
				...
				$this->data['get_discount_link'] = $this->url->link('information/information', 'information_id=19');	
				...
				$this->data['link_orders'] = $this->url->link('account/order', '');
