...
class ControllerProductQuickview extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$this->data['text_additional_info'] = $this->language->get('additional_info');
		...
		*/
			...
			$this->data['attribute_groups_special'] = $this->model_catalog_product->getProductAttributesByGroupId($this->request->get['product_id'], $this->data['special_attribute_group_id']);
