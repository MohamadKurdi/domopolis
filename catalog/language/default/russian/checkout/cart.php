...
$_['text_items']                              = 'Товаров: %s (%s)';				// $_['text_items']                              = 'Товаров: %s (%s)';
...
$_['text_quickorder_success'] = "Спасибо. Ваш заказ принят. Номер заказа: <span style='color:#e85c9e;'>%s</span><br /><span style='font-size:12px;'>Мы свяжемся с вами в ближайшее время.</span>";
...
$_['error_profile_required'] = 'Выберите платёжный профиль!';
...
$_['text_preorder_comment'] = 'Заявка на уточнение цены и наличия';
$_['text_preorder_success'] = 'Спасибо! Ваша заявка на предзаказ принята! Мы свяжемся с вами в ближайшее время.';