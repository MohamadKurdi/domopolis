...
$_['text_messenger_contact_b2b'] = '<b>DOMOPOLIS</b> має контракти понад як з 50 відомими європейськими брендами, що дозволяє надавати вигідні та привабливі умови для оптових покупців. Якщо вас зацікавила наша пропозиція, будь ласка, заповніть форму на нашому сайті та залиште свою контактну інформацію. Наш спеціаліст з обслуговування корпоративних клієнтів зв\'яжеться з вами найближчим часом, щоб обговорити всі деталі і запропонувати найкращі умови співпраці';
...
$_['text_has_in_supplier'] 		= 'На складі в Україні';
...
$_['text_dt_preorder_delivery'] = 'Відправка';
