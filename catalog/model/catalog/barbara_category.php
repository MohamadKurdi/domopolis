<?php
class ModelCatalogbarbaraCategory extends Model {
    ...
    public function getCategories() {
        ...
        if (isset($this->session->data['selected_store_id'])){
            ...
            $selected_store_condition = ' AND c2s.store_id = ' . (int)$this->session->data['selected_store_id'];
        } else {
            $store_id = '';
            $selected_store_condition = ' ';
        }

       // $this->categories = $this->cache->get('category.' . $this->config->get('config_language_id') . '.barbara.'.$store_id);
        ...
        if (!$this->categories) {
            ...
            //$this->cache->set('category.' . $this->config->get('config_language_id') . '.barbara.' . $store_id, $this->categories);
        }
        return $this->categories;
    }
