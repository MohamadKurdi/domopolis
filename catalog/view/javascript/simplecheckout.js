(function($) {
    window.Simplecheckout = function(params) {
        ...
        this.selectors = {
            ...
            defaultPaymentForm: "#simplecheckout_payment_form_default",
        ...
        this.setDirty = function($element) {
			...
			//console.log(self.useReloadingOfPaymentForm());
        ...
        this.copyPaymentFormFromDefaultIfIsEmptyAndFinishOrder  = function(){
            ...
            if (self.isPaymentFormEmpty()){
                console.log('Payment Form EMPTY! init default payment form');
                ...
                $(self.selectors.paymentForm).promise().done(function() {
                    $.ajax({ 
                        type: 'get',
                        url: 'index.php?route=payment/default/confirm',
                        success: function() {
                            location = self.params.successPage;
                        }		
                    });
                });
        ...
        this.previousStep = function($target) {
            $('.simplecheckout-step.simplecheckout_step_2').removeClass('simplecheckout_step_2');
            $('.simplecheckout-step.order-row').addClass('simplecheckout_step_1');
            var self = this;
        ...
        this.displayCurrentStep = function(changeStep) {
            ...
            if (self.stepsCount > 1) {
                ...
                if (self.currentStep == 2){
                    dataLayerPushStep(self.currentStep, 'CheckoutPageStep2Opened');
                }
            }
        ...
        this.reloadAll = function(callback, disableScroll, changeStep) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#shipping_address_address_id').SumoSelect({
                        floatWidth: 400
                    });
    ...
    */
	...
	SimplecheckoutBlock.prototype.initSumoSelect = function(callback) {
		$('#shipping_address_address_id').SumoSelect();
    }
