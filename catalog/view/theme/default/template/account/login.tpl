			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
				<div class="content">
					<div class="left-wrap">
						...
						<label for ="checkbox" style="display: inline-block; margin-bottom: 5px;"><?=$text_save_me ?></label>
						<?php //echo $text_remember_me; ?>
						<a class="forgotten-text" href="<?php echo $forgotten; ?>" style="text-decoration: underline;"><?php echo $text_forgotten; ?></a><br />
