  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <table class="form">
      <tr>
        ...
        <td><input type="text" class="login-entry-field field" name="to_name" value="<?php echo $to_name; ?>" />
      ...
      <tr>
        ...
        <td><input type="text" class="login-entry-field field" name="to_email" value="<?php echo $to_email; ?>" />
      ...
      <tr>
        ...
        <td><input type="text" class="login-entry-field field" name="from_name" value="<?php echo $from_name; ?>" />
      ...
      <tr>
        ...
        <td><input type="text" class="login-entry-field field" name="from_email" value="<?php echo $from_email; ?>" />
      ...
      <tr>
        ...
        <td><input type="text" name="amount" value="<?php echo $amount; ?>" size="5" />
          <?php if ($error_amount) { ?>
          <span class="error"  style="color: red; font-weight: 500;"><?php echo $error_amount; ?></span>
          <?php } ?></td>
      </tr>
    </table>
    <div class="buttons">
      <div class="right"><?php echo $text_agree; ?>
        ...
        <?php } ?>
        <input type="submit" value="<?php echo $button_continue; ?>" class="button btn btn-acaunt" />
      </div>
    </div>
  </form>
