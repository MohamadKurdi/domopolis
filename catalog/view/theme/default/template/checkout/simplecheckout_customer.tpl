	...
	<div class="tabs__content active">
		<div class="simplecheckout-block" id="simplecheckout_customer" <?php echo $hide ? 'data-hide="true"' : '' ?> <?php echo $display_error && $has_error ? 'data-error="true"' : '' ?>>
			...
			<div class="simplecheckout-block-content">
				...
				<!--btn-group-->
				<div class="btn-group">
					<a onclick="$('#simplecheckout_button_next').trigger('click');" class="btn" id="first_step_to_second_button"><?php echo $text_retranslate_36; ?>
...
<script>		
	$(document).ready(function(){$('#openLoginBoxTrigger').trigger('click');});
