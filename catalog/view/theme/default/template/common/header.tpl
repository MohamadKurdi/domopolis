	...
	<head>
		...
		<style type="text/css">
			<?php if ($this->config->get('config_store_id') == 2) {?>
				/*body{
				background-image: url(/catalog/view/theme/kp/img/snow-v2.jpg) !important;
				...
				.footer__down .snow-left:before{
				content: '';
				background-image: url(/catalog/view/theme/kp/img/snow-200.png);
				...
				.footer__down .snow-right:before{
				content: '';
				background-image: url(/catalog/view/theme/kp/img/snow-200.png);
				background-repeat: no-repeat;
				background-size: contain;
				...
				content: '';
				background-image: url(/catalog/view/theme/kp/img/snow-dekor-v2.png) !important;
				background-repeat: repeat !important;
				background-position: center !important;
				position: absolute;
				left: 0;
