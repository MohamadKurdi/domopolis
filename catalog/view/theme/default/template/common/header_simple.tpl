...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
	...
	<head>
		...
		<script src="/catalog/view/javascript/select2/dist/js/select2.min.js"></script>
		<script src="/catalog/view/javascript/select2/dist/js/i18n/ru.js"></script>
		<script src="/catalog/view/javascript/select2/dist/js/i18n/ua.js"></script>
