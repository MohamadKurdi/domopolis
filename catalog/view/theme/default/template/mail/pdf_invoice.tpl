	...
	<tbody>
		...
		<tr>
			...
			<table border="0" cellpadding="5" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td bgcolor="<?php echo $config['invoice_color']; ?>" style="color:#ffffff"<?php if($order['shipping_address']){ ?> width="50%"<?php } ?>><b><?php echo $text_to; ?></b></td>
						<?php if($order['shipping_address']){ ?>
							<td bgcolor="<?php echo $config['invoice_color']; ?>" style="color:#ffffff" width="50%"><b><?php echo $text_ship_to; ?></b></td>
						<?php } ?>
					</tr>
					<tr>
						<td>
