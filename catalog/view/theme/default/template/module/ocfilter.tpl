  ...
  <div class="list-group">
      ...
      <div class="list-group-item selected-options">
        ...
        <div class="ocfilter-option">
          ...
          <button type="button" onclick="location = '<?php echo $value['href']; ?>';" class="btn btn-xs btn-danger" style="padding: 1px 4px;">&times; <?php echo $value['name']; ?></button>
          <?php } ?>
        </div>
        <?php } ?>
				<?php $count = count($selecteds); $selected = $selecteds; $first = array_shift($selected); ?>
        <?php if ($count > 1 || count($first['values']) > 1) { ?>
        <button type="button" onclick="location = '<?php echo $link; ?>';" class="btn btn-block btn-danger" style="border-radius: 0;">&times; <?php echo $text_cancel_all; ?></button>
        <?php } ?>
      </div>
      <?php } ?>
      ...
      <?php foreach ($options as $option) { ?>
			...
			<?php if ($show_options) { ?>
      <button type="button" class="btn btn-default btn-block" data-toggle="collapse" data-target="#ocfilter-hidden-options" aria-expanded="true" aria-controls="ocfilter-hidden-options">&#9662;</button>
      <div class="collapse in" id="ocfilter-hidden-options" aria-expanded="true">
			<?php } else { ?>
      <button type="button" class="btn btn-default btn-block" data-toggle="collapse" data-target="#ocfilter-hidden-options" aria-expanded="false" aria-controls="ocfilter-hidden-options">&#9662;</button>
      ...
      <?php } ?>
            ...
            <p>
              <a href="#ocfilter-hidden-values-<?php echo $option['option_id']; ?>" data-toggle="collapse" aria-expanded="false" aria-controls="ocfilter-hidden-values"><?php echo $text_show_all; ?> &#9662;</a>
            </p>
