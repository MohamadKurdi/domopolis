<h2></h2>
  <?php if ($article) { ?>
	<div class="bnews-list<?php if ($this->config->get('bnews_display_style')) { ?> bnews-list-2<?php } ?>">
		<?php foreach ($article as $articles) { ?>
			<div class="artblock<?php if ($this->config->get('bnews_display_style')) { ?> artblock-2<?php } ?>">
