...
<a href="/information#delivery" onclick="do_notification_block(31,'delivery_block');return false;"><img src="catalog/view/theme/default/images/car.png">Варианты доставки <i class="fa fa-info-circle"></i></a>
</div>
