...
<div class="col-md-12 col-sm-12 col-xs-24 shipping-select">
	<a href="/information#delivery" onclick="do_notification_block(31,'delivery_block');return false;"><img src="catalog/view/theme/kitchde/images/car.png"> Варианты доставки <i class="fa fa-info-circle"></i></a>
</div>
