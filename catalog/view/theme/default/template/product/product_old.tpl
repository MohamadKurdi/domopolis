	...
	<div class="wrap">
		...
		<main class="product__body description">
			<div class="tabs item-page">
				...
				<div class="tabs__nav js-dragscroll-wrap2">
					<ul class="tabs__caption js-dragscroll2">
						...
						<li id="photo_btn"><?php echo $text_retranslate_8; ?> <?php if ($youtubes) { ?> <?php echo $text_retranslate_9; ?> <?php } ?></li>
								...
								<div id="markdown-reason-btn" class="markdown-reason do-popup-element" data-target="markdown-reason">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500.84 553" width="30" height="30">
										...
										<span class="ajax-module-reloadable" data-modpath="product/product/getPriceInfo" data-x="<?php echo $product_id; ?>" data-afterload="rebuildMaskInput">						
											<?php include(dirname(__FILE__).'/../blocks/price.tpl'); ?>
										</span>
										...
										<div class="delivery  
										<?php   
											if ($need_ask_about_stock || $can_not_buy) { ?>
											can_not_buy
											<?php } 
											?>">
															...
															<div class="kit__total-price">
																<div class="kit__group">													
																	...
																	<div class="sale_group">
																		...
																		<div class="kit__economy"><?php echo $text_retranslate_54; ?> <?php echo $additional_offer['absolute_diff']; ?></div>
																	</div>													
																</div>
																<div class="kit__btn">
										...
										<?php if ($additional_offers) { ?> 
											...
											<?php if ($additional_offers) { ?> 
												...
												<?php if ($this->config->get('show_wishlist') == '1')  { ?>                  
													<?php if ($logged) { ?>	
														<button onclick="addToWishList('<?php echo $product['product_id']; ?>');"  class="price__btn-favorite" title="<?php echo $button_wishlist; ?>">
			...
			<div class="popup-form" id="info_popup">
				<?php include(dirname(__FILE__).'/../common/popup_info.tpl'); ?>
			</div>
			...
			<?php if ($is_markdown) { ?>
				...
				<div class="popup-form" id="markdown-reason">
					<div class="object">
						...
						<div class="info-order-container">
							<?php include(dirname(__FILE__).'/popup/markdown-reason.tpl'); ?>
						</div>
					</div>
				</div>
				<!-- /markdown-reason -->
