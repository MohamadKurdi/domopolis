...
$(document).ready(function () {
    $(window).scroll(function () {
        if ($(this).scrollTop() > top_show) $("#top").removeClass('hide');
...
$(document).mouseup(function (e) {
    var div = $(".close_menu_mobile.catalog__btn,.menu-list, .catalog__btn, .mobile-menu__list, #popup-cart, #quick_popup, #formRev, #info_delivery, #notification_reviews, #callback-view, .popup-form, .popup_rev");
...
if (document.documentElement.clientWidth < 1000) {
    ...
    $("#mobile-category .parent.level1 a .btn-opnen-child-menu").click(function (e) {
        ...
        $(this).closest(".catalog_list__block").addClass('open_child_main_wrap');
        e.stopPropagation();
    });
    
    $("#mobile-category .parent.level1 .topmenu .btn-close-child-menu").click(function (e) {
        $(this).closest(".topmenu").removeClass("open_child");
        $(this).closest(".catalog_list__block").removeClass('open_child_main_wrap');
    });
...
$(".catalog_children__link-mob-btn").on("click", function () {
    let category = $(this).closest('.topmenu');
    category.toggleClass("open_child");
});

$(".contact__link-mob-btn").on("click", function () {
    $(".contact_list__block").toggleClass("open_menu");
});
