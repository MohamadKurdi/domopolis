...
<style type="text/css">
	...
	.bonus_head{
		...
		align-items: center;
		padding: 35px 0;
		background: -webkit-linear-gradient(90deg,#7ab04c,#1f9f9d);
		background: -moz-linear-gradient(90deg,#7ab04c,#1f9f9d);
		background: linear-gradient(90deg,#7ab04c,#1f9f9d);
		position: relative;
		border-radius: 5px;
		margin-bottom: 40px;
	}
    ...
    <div class="wrap two_column">
        ...
        <div class="account_content">
        	<div class="bonus_head">        		
				<p class="title">Domopolis Club</p>
				<p class="description"><? echo $text_retranslate_rewards_line_1; ?></p>
				<a href="<? echo $rewards_article_href; ?>"><? echo $text_retranslate_rewards_line_2; ?></a>
        	</div>
