...
<div>
	...
	<div  class='contact-content'>		
		<div class="content-respons left-modal">
			<?php if ($mob !='') {?>
				<div class="mob">
					...
					<a href="tel:<?php echo $mob; ?>"><span><?php echo $mob; ?></span></a>
				</div>
			<?php } ?>
			...
			<?php if ($mob2 !='') {?>
				<div class="mob">
					<i class="fas fa-mobile-alt"></i>
					<a href="tel:<?php echo $mob2; ?>"><span><?php echo $mob2; ?></span></a>
				</div>
			<?php } ?>
			...
			<?php if ($config_email_1 !='') {?>
				<div class="email">
					...
					<a href="mailto:<?php echo $config_email_1; ?>"><span><?php echo $config_email_1; ?></span></a>
				</div>
			<?php } ?>
		...
		<div class="right-modal content-respons" id="contact-body">
			...
			<span class="message">Ми готові допомогти та передзвонити за 15 хвилин. Лише замовте зворотній звʼязок</span>
			<div class='contact-loading' style='display:block'></div>
			<div class='contact-message' style='display:block'></div>
			<form id="data">
				<div class="contact-data">
					<div class="right-modal__items contact-name">
						<div>			
					...
					<div class="right-modal__items contact-phone">
						<div >			
					...
					<div class="right-modal__items contact-email">
						<div >			
					...
					<div class="right-modal__items contact-textarea">
						<div>			
		...
		$('#contact-send').on('click',function() {
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#contact-body').html("<img src='/catalog/view/theme/dp/img/load_more_white.svg'>");
				},
				complete: function() {									
				},
