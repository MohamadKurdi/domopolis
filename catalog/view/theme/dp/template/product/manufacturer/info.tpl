					...
					<div class="nav-group">
						<div class="swiper-prev-slide">
							<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
								<rect x="1" y="1" width="58" height="58" stroke="#1f9f9d" stroke-width="2"/>
								<path d="M35 42L23 30L35 18" stroke="#1f9f9d" stroke-width="3"/>
							</svg>
						</div>
						<div class="swiper-next-slide">
							<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
								<rect x="-1" y="1" width="58" height="58" transform="matrix(-1 0 0 1 58 0)" stroke="#1f9f9d" stroke-width="2"/>
								<path d="M25 42L37 30L25 18" stroke="#1f9f9d" stroke-width="3"/>
							</svg>
						</div>
					</div>				
					...
					<div class="catalog__content-head">
						...
						<div class="catalog__sort">
							...
							<?php if (empty($do_not_show_left_aside_in_list)) { ?>
								<div class="display-type" style="display: none;">
