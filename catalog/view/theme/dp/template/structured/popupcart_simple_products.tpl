		...
		<?php foreach ($products as $product) { ?>
			...
			<tr id="pid-<? echo $product['key'] ?>" class="ajaxtable_tr_new">
				...
				<td class="names_product">
					...
					<? } ?>
					<a href="<?=$product['href'] ?>" target="_blank"><?php echo $product['name']; ?></a>
					...
					<?php if ($this->config->get('config_divide_cart_by_stock')) { ?>	
						<?php if ($product['is_certificate']) { ?>
							<small class="alert alert-success alert-no-padding alert-small"><small><?php echo $this->language->get('text_has_in_stock'); ?></small>
						<?php } elseif ($product['fully_in_stock']) { ?>
							<small class="alert alert-success alert-no-padding alert-small"><?php echo $this->language->get('text_has_in_stock'); ?> <?php echo $product['amount_in_stock']; ?> шт, <?php echo $this->language->get('text_line_delivery'); ?> <?php echo $text_in_stock_delivery_term; ?></small>
						<?php } elseif ($product['current_in_stock']) { ?>
							<small class="alert alert-warning alert-no-padding alert-small"><?php echo $this->language->get('text_has_in_stock'); ?> <?php echo $product['amount_in_stock']; ?> шт, <?php echo $this->language->get('text_line_delivery'); ?> <?php echo $text_in_stock_delivery_term; ?></small>
						<?php } else { ?>						
							<small class="alert alert-danger alert-no-padding alert-small"><?php echo $this->language->get('text_has_no_in_stock'); ?>, <?php echo $this->language->get('text_line_delivery'); ?> <?php echo $text_not_in_stock_delivery_term; ?></small>
						<?php } ?>
					<?php } ?>
