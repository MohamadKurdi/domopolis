<div class="reviews-col__item">
	<div class="reviews__author-name">
		<div>
			<div class="photo">
				<?php echo mb_substr($onereview['author'], 0, 1,'UTF-8') ?>
			</div>
			<div class="reviews__about">
				<span class="name"><? echo $onereview['author']; ?></span>
				<span class="date"><? echo $onereview['date_added']; ?></span>
			</div>
		</div>
		<span class="rate rate-<?php echo $onereview['rating']; ?>"></span>
	</div>
