                ...
                <div class="footer__links-item applinks_wrap">
                	...
                	<div class="applinks">
						...
						<?php if ($this->config->get('config_android_playstore_enable')) { ?>
							<a href="<?php echo $this->config->get('config_android_playstore_link'); ?>" target="_blank" rel="noindex nofollow"> 
								<?php if ($this->config->get('config_language_id') == 6) { ?>
									<img src="/catalog/view/theme/kpkz/img/gplay_ua.svg" height="55px" loading="lazy" alt="logo google play"> 
									<?php } else { ?>
									<img src="/catalog/view/theme/kpkz/img/gplay_ru.svg" height="55px" loading="lazy" alt="logo google play"> 
								<?php } ?>
							</a> 
						<?php } ?>
                		...
                		<a target="_blank" id="footer_app_button" style="display: none;"> 
                			<?php if ($this->config->get('config_language_id') == 6) { ?>
                				<img src="/catalog/view/theme/kpkz/img/pwa_ua.svg" height="55px" loading="lazy" alt="logo pwa"> 
								<?php } else { ?>
                				<img src="/catalog/view/theme/kpkz/img/pwa_ru_new.svg" height="55px" loading="lazy" alt="logo pwa"> 
							<?php } ?>
						</a> 
					</div>
        ...
        <div class="wrap">
            <div class="footer__container">
                <div class="footer__copyright">
                    ...
                    <?php if (!$this->config->get('config_warmode_enable')) { ?>                    	
						...
						<div class="lang-menu <? if ($this->config->get('config_store_id') == 0) { ?>selected-lang_ru<?php } elseif ($this->config->get('config_store_id') == 1) {?>selected-lang_ua<?php } elseif ($this->config->get('config_store_id') == 2) {?>selected-lang_kz<?php }elseif ($this->config->get('config_store_id') == 5) {?>selected-lang_by<?php } ?>">
							...
							<ul>
								<li class="href_ru">
									<a href="<?php echo $href_ru; ?>"><img src="/catalog/view/theme/kpkz/img/flags/ru.png" alt="Россия" loading="lazy"></a>
								</li>
								<li class="href_ua">
									<a href="<?php echo $href_ua; ?>"><img src="/catalog/view/theme/kpkz/img/flags/ua.png" alt="Украина" loading="lazy"></a>
								</li>
								<li class="href_by">
									<a href="<?php echo $href_by; ?>"><img src="/catalog/view/theme/kpkz/img/flags/by.png" alt="Беларусь" loading="lazy"></a>
								</li>
								<li class="href_kz">
									<a href="<?php echo $href_kz; ?>"><img src="/catalog/view/theme/kpkz/img/flags/kz.png" alt="Казахстан" loading="lazy"></a>
								</li>
							</ul>
                ...
                <ul class="footer__payments">
                    <?php if ($this->config->get('config_store_id') == 5) {?>
                        <li>
                            <img src="/catalog/view/theme/kpkz/img/all.png" alt="" style="max-width: 486px;" class="by-img"  loading="lazy">
						</li>
						<?php } else { ?>
                        <li>
                            <img src="/catalog/view/theme/kpkz/img/master-card.svg" alt=""  loading="lazy">
						</li>
                        <li>
                            <img src="/catalog/view/theme/kpkz/img/visa.svg" alt=""  loading="lazy">
						</li>
                        <?php if ($this->config->get('config_store_id') == 1) {?>
    						<li>
                                <img src="/catalog/view/theme/kpkz/img/LIQPAY.png" alt="" width="47" loading="lazy">
							</li>
						<?php } ?>
                        <li>
                            <img src="/catalog/view/theme/kpkz/img/PayKeeper.svg" alt="" loading="lazy">
						</li>
                        <li>
                            <img src="/catalog/view/theme/kpkz/img/paypal.svg" alt="" loading="lazy">
						</li>
					<?php } ?>
				</ul>
			</div>
...
<style type="text/css">
	...
	color: #2121217d;
	cursor: pointer;
	background-image: url(/catalog/view/theme/kpkz/img/close-modal.svg);
...
<div class="popup-form" id="callback-view" style="display:none;">
    <div class="object">
...
<div class="popup-form" id="report_bug" style="display:none;">
    <div class="object">
        <div class="overlay-popup-close"><i class="fas fa-times"></i></div>
        <div class="info-order-container">
...
<? if (ADD_METRICS_TO_FRONT) { ?>
	...
	<?php if ($this->config->get('config_sendsay_enable_marketing')) { ?>
		<script type="text/javascript"> (function(d,w,t,u,o,s,v) { w[o] = w[o] || function() { (w[o].q = w[o].q || []).push(arguments) };s = d.createElement("script");s.async = 1; s.src = u;v = d.getElementsByTagName(t)[0]; v.parentNode.insertBefore(s, v); })(document,window,"script","//image.sendsay.ru/js/target/tracking_v2.min.js","sndsy"); sndsy("init", { fid: "<?php echo $this->config->get('config_sendsay_fid');?>", v: "1.0" }); sndsy("send", {}); </script> 
	<?php } ?>

	<?php if ($this->config->get('config_sendsay_enable_webpush')) { ?>
		<script>(function(a,b,c,d){var e=a.getElementsByTagName(b)[0],f=a.createElement(b);f.async=!0,f.src="https://image.sendsay.ru/app/js/sdk/sdk.min.js",f.id="sendsay-sdk-script",f.dataset.accountId=c,f.dataset.siteId=d,e.parentNode.insertBefore(f,e)})(document,"script","<?php echo $this->config->get('config_sendsay_fid');?>","<?php echo $this->config->get('config_sendsay_webpush_id');?>");</script> 
	<?php } ?>
