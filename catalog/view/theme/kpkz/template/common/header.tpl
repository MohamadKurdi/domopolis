...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
	...
	<head>
		...
		<style type="text/css">		
			...
			background-image: url(/catalog/view/theme/kpkz/img/load_more.svg);
			}
			.grecaptcha-badge{
			...
			#new_mmenu div[data-tooltip]:hover::before{
				display: none !important;
			}
...
/*			max-height: 250px;*/
			...
			.brand-top{padding:0;margin-top:0;max-width:5000px;}
			...
			.brand-slider{position:relative;padding:15px 0 !important}
			...
			.header-banner .close{position:absolute;right:40px;width:15px;height:15px;line-height:15px;top:0;bottom:0;margin:auto;cursor:pointer;background-image:url(/catalog/view/theme/kpkz/img/close-modal.svg);background-size:15px 15px;background-repeat:no-repeat;text-align:center;background-position:center;opacity:.5;background-color:transparent}
			...
			content: '';
			background: url(/catalog/view/theme/kpkz/img/snow1.png);
			display: block;
			position: absolute;
			left: 0;
			top: 0;
					...
					<div class="inner">
						...
						<div class="social-contact">
							<ul class="social-contact__list">
								<li>
									<a href="http://m.me/104116757981722" class="facebook" rel="noindex nofollow" alt="Facebook" title="Facebook">
										<i class="fab fa-facebook-messenger"></i>
									</a>
								</li>
								<li>
									<a class="viber" href="viber://pa?chatURI=kitchen-profi" rel="noindex nofollow" alt="Viber" title="Viber">
								...
								<li>
									<a class="tg" href="https://teleg.one/kitchenprofi_bot" rel="noindex nofollow" alt="Telegram" title="Telegram">
