	...
	<head>
		...
		<style type="text/css">
			#ui-datepicker-div{
			    ...
			    box-shadow: 1px 1px 14px #0000005e;
			    border-radius: 4px;
			    overflow: hidden;
			}
			#simplecheckout_shipping .simplecheckout-methods-table .row-header5 .field-label,
			#simplecheckout_shipping .simplecheckout-methods-table .row-header4 .field-label{
				width: 100%;
			}
			#simplecheckout_shipping .simplecheckout-methods-table .row-header4 .field-label h1{
				display: flex;
			    align-items: center;
			    gap: 15px;
			    font-size: 17px;
			...
			#simplecheckout_shipping .simplecheckout-methods-table .row-header5 .field-label legend{
			    font-size: 13px;
    			color: #888;
    			line-height: normal;
			}
			#simplecheckout_shipping .simplecheckout-methods-table .row-shipping_passport_given{
				margin-top: 10px;
			}
			#simplecheckout_shipping .simplecheckout-methods-table .row-shipping_passport_given .field-input textarea{
			    resize: vertical;
			    min-height: 60px;
			...
			content: '';
			background-image: url("/catalog/view/theme/kpkz/img/money.svg");
			background-size: contain;
			width: 20px;
			height: 18px;
			...
			@media screen and (max-width: 768px) {
				#simplecheckout_shipping .simplecheckout-methods-table .row-shipping_passport_given .field-label{
					margin-bottom: 10px;
				}
				.checkout-steps__select {
				padding-left: 0;
