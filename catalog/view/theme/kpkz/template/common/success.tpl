			...
			<div class="success_page_wrap">
				<div class="success_page_item">
					...
					<div class="success_page_item_content"><span><?php echo $text_retranslate_2; ?> <?php echo $order_data['order_id']; ?> <?php echo $text_retranslate_3; ?> <?php echo $order_data['date_order']; ?></span>
						...
						<p><b><?php echo $text_retranslate_4; ?> <?php echo $order_data['email']; ?></b></p>
											...
											<?php if ($this->config->get('config_sendsay_enable_marketing')){ ?>
												(window['sndsyApiOnReady'] = window['sndsyApiOnReady'] || []).push(function () {
													sndsyApi.ssecEvent(
														'ORDER',
														[{
															'transaction_id'	: '<?php echo $google_ecommerce_info['transactionId']; ?>',
														...
														<?php if ($this->customer->getIfRealEmail($google_ecommerce_info['transactionEmail'])) { ?>,
															{ email: '<?php echo $this->customer->getIfRealEmail($google_ecommerce_info['transactionEmail']); ?>' } 
														<?php } ?>
													);
												});
