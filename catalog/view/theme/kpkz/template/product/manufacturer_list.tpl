...
<style type="text/css">
    .manufacturer-list .manufacturer-content ul li:not(.list) a .bg-poster{
        background: rgb(191 191 191 / 28%) !important;
    }
    .manufacturer-list  span.label-new{
        background: #51a881;
        color: #fff;
        padding: 0 5px;
        font-size: 12px;
...
/*     .manufacturer-country .manufacturer-country-block .manufacturer-country-item:nth-of-type(n+7){
    ...
    .manufacturer-alphabet .manufacturer-alphabet-block .manufacturer-alphabet-item a {
     ...
     .manufacturer-list .manufacturer-content ul:not(.image) li:first-of-type{
        padding-left: 35px;
    }
    }
</style>
                    ...
                    <div class="manufacturer-country-item">
                        <a href="<?php echo $countrybrand['href']; ?>" title="<?php echo $countrybrand['name']; ?>">
                            <?php if ($countrybrand['flag']) { ?>
                                <img src="/catalog/view/theme/kpkz/img/flags/brand/<?php echo $countrybrand['flag']?>.png" alt="<?php echo $countrybrand['name']; ?>">
                            <?php } ?>
                                    ...
                                    <li <?php if ($i == 0){ ?> id="<?php echo $category['name']; ?>" <?php } ?> class="list">
                                        <div class="item img-box hidden">
                                            ...
                                            <div class="title-manufacturer">
                                                <span><?php echo $category['manufacturer'][$i]['name']; ?><?php if($category['manufacturer'][$i]['new']){?><span class="label-new">Новый</span><?php } ?></span>
                                            </div>
                                        </div>
                              			<div class="item desc">
                                            <a href="<?php echo $category['manufacturer'][$i]['href']; ?>"><?php echo $category['manufacturer'][$i]['name']; ?><?php if($category['manufacturer'][$i]['new']){?><span class="label-new">Новый</span><?php } ?></a>
                                        </div>
                                    </li>
                                <?php } ?>
                            <?php } ?>
