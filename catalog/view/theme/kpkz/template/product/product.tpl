			...
			<div class="product-info__left-col">
				...
				<div class="product-info__left-col__wrap">
					...
					<div class="product-info__code">
						<span class="code">
							<?php echo $text_code ?>: <?php echo $product_id; ?>
						</span>						
		...
		<main class="product__body description">
			<div class="tabs item-page">
				...
				<div class="tabs__content main_btn active" id="product-tab-info" style="position: relative;">
					...
					<div class="item-column " id="product-cart" style="position: relative; ">
									...
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500.84 553" width="30" height="30">
										...
										<?php if ($free_delivery) { ?>
											<?php if ($free_delivery == 'moscow') { ?>
												<div class="delivery_info_free ruMoskow">
													<img src="/catalog/view/theme/kpkz/img/banner-logo.jpg" alt="" loading="lazy">
										...
										<div class="pluses-item">
											<ul <? if (empty($bought_for_week)) { ?>style="display: flex;flex-direction: row-reverse;"<? } ?>>
												<? if ($bought_for_week) { ?>
													<li>
														<img src="/catalog/view/theme/kpkz/img/pluses-icon3.svg" alt="" loading="lazy">
												...
												<li>
													<a href="javascript:void(0)" onclick="do_notification_block(31,'delivery_block');return false;" data-target="info_delivery" class="do-popup-element" >
														<img src="/catalog/view/theme/kpkz/img/pluses-icon-dev.svg" alt="" loading="lazy">
						...
						<div class="sticky-block base-padding 3333">
									...
									sndsyApi.ssecEvent(
										...
										[{											
        									'transaction_dt': "<?php echo date('Y-m-d H:i:s'); ?>",
       										'transaction_sum': '<?php echo $google_ecommerce_info['price']; ?>',
        									'update_per_item': 1,
											"items": [{
											'id'			: '<?php echo $google_ecommerce_info['product_id']; ?>',	
											'qnt'			: '1',							
											'available'		: <?php echo $google_ecommerce_info['available']; ?>,
											<?php if (!empty($google_ecommerce_info['model'])) { ?>
												'model'		: '<?php echo $google_ecommerce_info['model']; ?>',
											<?php } ?>
											'name'			: '<?php echo $google_ecommerce_info['name']; ?>',
											'picture'		: ['<?php echo $popup; ?>'],
											'price'			: '<?php echo $google_ecommerce_info['price']; ?>',
											<?php if (!empty($google_ecommerce_info['old_price'])) { ?>
												'old_price'	: '<?php echo $google_ecommerce_info['old_price']; ?>',
											<?php } ?>
											'url'			: '<?php echo $google_ecommerce_info['url']; ?>',
											'vendor'		: '<?php echo $google_ecommerce_info['brand']; ?>',
											'category_id'	: '<?php echo $google_ecommerce_info['main_category_id']; ?>',
											'category_paths': ['<?php echo $google_ecommerce_info['category']; ?>']
											}]
										}],
										(window._customer_data_real_email) ? { email: undefined } : undefined
									);
								});
			...
			<script type="text/javascript">				
				$(document).ready(function() {					
					...
					<?php if ($this->config->get('config_sendsay_enable_marketing')){ ?>
						var customerDataPromise = new Promise(function(resolve, reject) {
							var checkCustomerDataInterval = setInterval(function() {
								if (window._customer_data_loaded) {
									clearInterval(checkCustomerDataInterval);
									resolve();
								}
							}, 100);
						});

						customerDataPromise.then(function() {
							(window['sndsyApiOnReady'] = window['sndsyApiOnReady'] || []).push(function () {
								sndsyApi.ssecEvent(
									'VIEW_PRODUCT',
									[
									{
										'id'		: '<?php echo $google_ecommerce_info['product_id']; ?>',								
										'available'	: <?php echo $google_ecommerce_info['available']; ?>,
										<?php if ($google_ecommerce_info['model']) { ?>
											'model'		: '<?php echo $google_ecommerce_info['model']; ?>',
										<?php } ?>
										'name'		: '<?php echo $google_ecommerce_info['name']; ?>',
										'picture'	: ['<?php echo $popup; ?>'],
										'price'		: '<?php echo $google_ecommerce_info['price']; ?>',
										<?php if ($google_ecommerce_info['old_price']) { ?>
											'old_price'	: '<?php echo $google_ecommerce_info['old_price']; ?>',
										<?php } ?>
										'url'		: '<?php echo $google_ecommerce_info['url']; ?>',
										'vendor'	: '<?php echo $google_ecommerce_info['brand']; ?>',
