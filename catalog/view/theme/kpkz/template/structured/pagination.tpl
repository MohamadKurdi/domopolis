...
<?php if ($pagination) { ?>
	...
	<div class="pages" id="pagination__wrap">
		...
		<button id="load-more_btn" class="pages__show-more btn-border" onclick="getMoreProducts();">Показать еще <?php echo $limit; ?></button>
		...
		function getMoreProducts(){	
			...
			$.ajax({
				...
				beforeSend : function(){		
					...
					$button.html("<img src='/catalog/view/theme/kpkz/img/load_more_white.svg'>");
