...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
	...
	<head>
		...
		<style type="text/css">		
			...
			background-image: url(/catalog/view/theme/kpua/img/load_more.svg);
			}
			.grecaptcha-badge{
			...
			.header-banner .close{position:absolute;right:40px;width:15px;height:15px;line-height:15px;top:0;bottom:0;margin:auto;cursor:pointer;background-image:url(/catalog/view/theme/kpua/img/close-modal.svg);background-size:15px 15px;background-repeat:no-repeat;text-align:center;background-position:center;opacity:.5;background-color:transparent}
			...
			content: '';
			background: url(/catalog/view/theme/kpua/img/snow1.png);
			display: block;
			position: absolute;
			left: 0;
			top: 0;
