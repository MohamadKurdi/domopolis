...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body text="<?php echo $config['body_font_color']; ?>" link="<?php echo $config['body_link_color']; ?>" alink="<?php echo $config['body_link_color']; ?>" vlink="<?php echo $config['body_link_color']; ?>" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
		<span style="font-size:1px;">Інтернет-магазин преміального європейського посуду | Kitchen-Profi | Дизайнерський Посуд Для Кухні Найкращі Європейські Бренди | Kitchen-Profi</span>
		...
		<div id="emailTemplate">
			<table style="width: 650px; margin: auto;" class="emailStyle<?php echo ucwords($config['style']); ?>" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="<?php echo $config['body_bg_color']; ?>">
										...
										<div class="mainContainer" align="<?php echo $config['page_align']; ?>">
											<table class="mainContainer emailTableShadow emailHeaderHeight" width="100%" cellpadding="0" cellspacing="0" border="0" align="<?php echo $config['page_align']; ?>" height="<?php echo $config['header_height']; ?>">
												<tr>
													...
													<td>
														<table class="emailHeader" border="0" cellspacing="0" cellpadding="0" width="100%" <?php if($config['header_bg_image']){ ?> background="<?php echo $config['header_bg_image']; ?>"<?php } ?> bgcolor="<?php echo $config['header_bg_color']; ?>" style="min-width: 650px; width:650px; padding: 0px 30px 0px 30px !important;">
															<tr>
												                          		...
												                          		<table style="padding-top: 0 !important; vertical-align: top !important;">
												                          			<tr style="padding-top: 0 !important; vertical-align: top !important;">
												                          				<td valign="top" align="right" style="text-align: right; vertical-align: middle; padding-bottom: 10px" idth="100%">
												                          					<a target="_blank" href="https://kitchen-profi.com.ua/bar-i-steklo" style="margin: 0 3px 0 0">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/1.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/interer" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/2.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/bytovaya-tehnika" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/3.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/tekstil" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/4.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/stolovye-pribory" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/5.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/prinadlezhnosti" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/6.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/servirovka" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/7.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/posuda" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/8.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/nozhi" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/11.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/kofe-i-chaj" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/13.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/dlya-vypechki" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/14.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/stolovye-pribory" style="margin: 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/15.png" alt="messenger" width="24" height="24">
															                          		</a>
															                          		<a target="_blank" href="https://kitchen-profi.com.ua/gril-i-barbekyu" style="margin: 0 0 0 3px">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/category/16.png" alt="messenger" width="24" height="24">
															                          		</a>
												                          				</td>
												                          			</tr>
												                          			<tr>
												                          				<td valign="top" align="right" style="text-align: right; vertical-align: top; margin-top: 20px;" idth="100%">
												                          					<span style="height: 24px;display: inline-block;vertical-align: top;line-height: 24px;">Будемо раді відповісти на Ваші запитання:</span>
												                          					<a target="_blank" href="https://m.me/102808698946930" style="display:inline-block;margin: 0 5px;width: 24px;height: 24px;">
															                          			<img title="messenger" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/messenger.png" alt="messenger" width="25" height="25">
															                          		</a>
															                          		<a target="_blank" href="viber://pa?chatURI=kitchenprofiua" style="display:inline-block;margin: 0 10px;width: 24px;height: 24px;">
															                          			<img title="viber" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/viber.png" alt="viber" width="25" height="25">
															                          		</a>
															                          		<a target="_blank" href="https://t.me/kitchenprofiua_bot" style="display:inline-block;margin: 0 5px;width: 24px;height: 24px;">
															                          			<img title="teleg" src="https://kitchen-profi.com.ua/catalog/view/theme/kpua/template/mail/img/telegram.png" alt="teleg" width="25" height="25">
															                          		</a>
												                          				</td>
												                          			</tr>
												                          		</table>
										...
										<div class="mainContainer" align="<?php echo $config['page_align']; ?>">
											<table class="mainContainer emailTableShadow" width="100%" cellpadding="0" cellspacing="0" border="0" align="<?php echo $config['page_align']; ?>">
												<tr>
													<?php if(isset($config['shadow_left']['bg'])) echo $config['shadow_left']['bg']; ?>
													<td>
														<table style="min-width: 650px; width:650px;" border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="<?php echo $config['page_bg_color']; ?>">
															<tr>
															...
															<?php /*
																...
																<thead>
																<tr>
																<th class="textCenter" colspan="3" style="font-size: 13px; font-weight: 400; padding: 10px 6px; text-align: center; font: 16px Verdana;" bgcolor="#ededed">Дізнавайтеся про акції та промокоди першими у месенджерах</th>
																</tr>
																</thead>
																<tbody>
																<tr>
																...
																<thead>
																<tr>
																<th class="textCenter" colspan="4" style="font-size: 13px; font-weight: 400; padding: 10px 6px; text-align: center; font: 16px Verdana;" bgcolor="#ededed">Підписуйтесь на Kitchen Profi у соціальних мережах</th>
																</tr>
																</thead>
																<tbody>
																<tr>
																						...
																						<tbody>
																							<tr id="brend_list" style="border-collapse:collapse;">
																								<td align="center" style="padding:0;Margin:auto;" valign="top">
																									<a href="https://kitchen-profi.com.ua/brands/m201?utm_campaign=07_12_20_ru&amp;utm_term=[EMAIL]&amp;utoken=[UTOKEN]&amp;utm_source=Email&amp;utm_medium=Mailing" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:14px;text-decoration:underline;color:#333333;" target="_blank">
																										<img alt="Villeroy &amp; Boch" height="75" src="https://kitchen-profi.com.ua/send/kp/img/Villeroy_boch-logo1-150x150q100.png" style="Margin: auto; display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" title="Villeroy &amp; Boch" width="75">
																									</a>
																								</td>
																								<td align="center" style="padding:0;Margin:auto;" valign="top">
																									<a href="https://kitchen-profi.com.ua/brands/m202?utm_campaign=07_12_20_ru&amp;utm_term=[EMAIL]&amp;utoken=[UTOKEN]&amp;utm_source=Email&amp;utm_medium=Mailing" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:14px;text-decoration:underline;color:#333333;" target="_blank">
																										<img alt="wmf" height="75" src="https://kitchen-profi.com.ua/send/kp/img/WMF_Logo-150x150q100.png" style="Margin: auto;display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" title="WMF" width="75">
																									</a>
																								</td>
																								<td align="center" style="padding:0;Margin:auto;" valign="top">
																									<a href="https://kitchen-profi.com.ua/brands/m476?utm_campaign=07_12_20_ru&amp;utm_term=[EMAIL]&amp;utoken=[UTOKEN]&amp;utm_source=Email&amp;utm_medium=Mailing" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:14px;text-decoration:underline;color:#333333;" target="_blank">
																										<img alt="seltmann" height="75" src="https://kitchen-profi.com.ua/send/kp/img/000seltmann-150x150q100.png" style="Margin: auto;display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" title="Seltmann" width="75">
																									</a>
																								</td>
																								<td align="center" style="padding:0;Margin:auto;" valign="top">
																									<a href="https://kitchen-profi.com.ua/brands/m471?utm_campaign=07_12_20_ru&amp;utm_term=[EMAIL]&amp;utoken=[UTOKEN]&amp;utm_source=Email&amp;utm_medium=Mailing" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:14px;text-decoration:underline;color:#333333;" target="_blank">
																										<img alt="zwilling" height="75" src="https://kitchen-profi.com.ua/send/kp/img/zwilling-logo(2)-150x150q100.png" style="Margin: auto;display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" title="Zwilling" width="75">
																									</a>
																								</td>
																							</tr>
																						</tbody>
																					...
																					<table cellpadding="0" cellspacing="0" width="100%" class="es-menu" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
																						<tr class="links" style="border-collapse:collapse">
																							<td align="center" width="100.00%" style="Margin:0;padding-left:5px;padding-right:5px;padding-top:12px;padding-bottom:12px;border:0; text-align: center !important;" id="esd-menu-id-0" bgcolor="transparent">
																								<a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;text-decoration:none;display:block;color:#000000" href="https://kitchen-profi.com.ua/rasprodazha?utm_campaign=07_12_20_ru&amp;utm_term=[EMAIL]&amp;utoken=[UTOKEN]&amp;utm_source=Email&amp;utm_medium=Mailing">ЗНИЖКИ ДО -50%</a>
																							</td>
																						</tr>
																					</table>
																				</td>
																					...
																					<table cellpadding="0" cellspacing="0" width="100%" class="es-menu" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
																						<tr class="links" style="border-collapse:collapse">
																							<td align="center" width="100.00%" style="Margin:0;padding-left:5px;padding-right:5px;padding-top:12px;padding-bottom:12px;border:0" id="esd-menu-id-0" bgcolor="transparent">
																								<a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;text-decoration:none; text-align: center !important;display:block;color:#000000" href="https://kitchen-profi.com.ua/blog?utm_campaign=07_12_20_ru&amp;utm_term=[EMAIL]&amp;utoken=[UTOKEN]&amp;utm_source=Email&amp;utm_medium=Mailing">БЛОГ</a>
																							</td>
																						</tr>
																					</table>
																				</td>
																					...
																					<table cellpadding="0" cellspacing="0" width="100%" class="es-menu" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
																						<tr class="links" style="border-collapse:collapse">
																							<td align="center" width="100.00%" style="Margin:0;padding-left:5px;padding-right:5px;padding-top:12px;padding-bottom:10px;border:0" id="esd-menu-id-0" bgcolor="transparent">
																								<a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;text-decoration:none;display:block; text-align: center !important;color:#000000" href="https://kitchen-profi.com.ua/brands?utm_campaign=07_12_20_ru&amp;utm_term=[EMAIL]&amp;utoken=[UTOKEN]&amp;utm_source=Email&amp;utm_medium=Mailing">БРЕНДИ</a>
																							</td>
																						</tr>
																					</table>
																				</td>
										                        	 		...
										                        	 		<tr style="padding: 20px">
										                        	 			<td id="social_footer" style="text-align: center !important;padding-top: 20px !important;">
										                          					<a href="https://www.facebook.com/Kitchen-Profi-104116757981722/"  style="margin: 0 20px">
										                          						<img title="Facebook" src="https://kitchen-profi.com.ua/send/kp/img/facebook-logo-colored.png" alt="Fb" height="32" width="32">
										                          					</a>
										                          					<a href="https://twitter.com/KitchenProfi" style="margin: 0 20px">
										                          						<img title="Twitter" src="https://kitchen-profi.com.ua/send/kp/img/twitter-logo-colored.png" alt="Tw" height="32" width="32">
										                          					</a>
										                          					<a href="https://www.instagram.com/kitchen_profi.ua/" style="margin: 0 20px">
										                          						<img title="instagram" src="https://kitchen-profi.com.ua/send/kp/img/instagram-logo-colored.png" alt="Inst" height="32" width="32">
										                          					</a>
									                          					</td>
									                          				</tr>
										                       			</tbody>
											...
											<table class="mainContainer" width="100%" cellpadding="0" cellspacing="0" border="0" align="<?php echo $config['page_align']; ?>">
												<tr>
													<td width="100%">
														...
														<table style="width: 650px" class="emailShadow emailTableShadow" border="0" cellspacing="0" cellpadding="0" width="100%">
															<tr>
														...
														<table style="width: 650px" class="emailFooterText" border="0" cellspacing="0" cellpadding="0" width="100%" height="<?php echo $config['footer_height']; ?>">
															<tr>
