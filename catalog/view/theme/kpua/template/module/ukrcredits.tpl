		...
		<div class="prop_info">
			<div class="prop_calc">
				...
				<div class="prop_permounth">
					<?php echo $text_per; ?> <span><?php echo round($credit['price'], 2); ?></span> <?php echo $currency_left; ?>
				</div>
				<div class="prop_price">
					<?php echo $text_total; ?> <span><?php echo round($credit['price']); ?></span> <?php echo $currency_left; ?>
				</div>					
			</div>
