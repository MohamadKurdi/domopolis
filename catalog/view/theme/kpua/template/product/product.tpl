...
<style>
	...
	.wrap_variant .item_variant.variant_hidden {
	    display: none
	}

	.wrap_variant.open .item_variant.variant_hidden {
	    display: block
	}

	.wrap_variant .item_variant .tooltiptext {
	    display: none
	}

	.wrap_variant .variant-link-toggle {
	    content: '';
	...
	.wrap_variant .variant-link-toggle:hover {
	    box-shadow: 0 0 16px rgb(0 0 0 / 20%);
	    border-color: #c0e856
	}
	.wrap_variant .item_variant:hover .tooltiptext{
		display: flex;
	    position: absolute;
	    background: #fff;
	    bottom: 100%;
	...
	.wrap_variant .item_variant .tooltiptext .price{
		padding: 0;
	    border: 0;
	    font-weight: 500;
	    color: #51a881;
	...
	.wrap_variant.open .variant-link-toggle {
	    transform: rotate(0deg)
	}

	.wrap_variant .variant-link-toggle i {
	    font-size: 14px
	}

	.wrap_variant .item_variant a {
	    display: flex;
	    align-items: center;
	    justify-content: center;
	    width: 50px;
	...
	.wrap_variant .item_variant a::before {
	    content: '';
	...
	.wrap_variant .item_variant a:hover::before {
	    border-color: #51a881
	}

	.wrap_variant .item_variant a img {
	    width: 100%;
	    height: 100%
	}
	...
	.related_slider .swiper-container {
	    padding-bottom: 176px;
	}
	.item-bottom.has_related{
		margin-top: -160px;
		position: relative;
		z-index: 1;
	}
	.related_slider.nav-group {
		display: none;
	}
	.related_slider .nav-group .swiper-next-slide, .related_slider .nav-group .swiper-prev-slide {
	    position: absolute;
	    top: calc(30% - 0px);
	    display: flex;
	    justify-content: center;
	...
	.related_slider .nav-group .swiper-prev-slide {
	    left: 2%;
	}
	.related_slider .nav-group .swiper-next-slide {
	    right: 2%;
	}
	.related_slider .nav-group .swiper-button-disabled{
		opacity: 0.7;
		cursor: default;
	}
	@media screen and (max-width: 480px) {
		...
		.waitlist-block .waitlist__phone::placeholder {
			opacity: 0.5;
		}
		.errors, #waitlist-form #error_phone {
		    font-size: 12px;
		}
...
<section id="product-detail" class="article product-detail">
	<div class="wrap">
		...
		<main class="product__body description">
					...
					<div class="item-column " id="product-cart" style="position: relative; ">
						...
						<?php if (!empty($active_action)) { ?>
							<div class="product-info__active_action">					
								<h3><?php echo $text_retranslate_action; ?> <?php echo $active_action['caption']; ?></h3>
						...
						<div class="product-info__delivery <?if ($free_delivery) { ?>free_delivery_wrap<? }?>">					
							<div class="wrap_block">
								...
								<? if ($bought_for_week) { ?>
									<div class="bought_for_week">
										<img src="/catalog/view/theme/kpua/img/pluses-icon3.svg" alt="" loading="lazy">
								...
								<div id="markdown-reason-btn" class="markdown-reason do-popup-element" data-target="markdown-reason">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500.84 553" width="30" height="30">
										...
										<?php if ($free_delivery) { ?>
											<? if($free_delivery == 'kyiv') { ?>
												<div class="delivery_info_free uaKyiv">
													<img src="/catalog/view/theme/kpua/img/banner-logo_3.jpg" alt="" loading="lazy">
										...
										<?php if ($credits_status) { ?>
											<div class="product_credit_wrap">
												<?php foreach ($credits_info as $credit) { ?>
													<div class="item">
											...
											<script type="text/javascript">
												$('#button-ukrcredits').bind('click', function() {
													$.ajax({
														...
														success: function(json) {
															...
															if (json['success']) {
																$.ajax({
												                    url: 'index.php?route=module/ukrcredits/loadpopup',
												                    type: 'GET',
												                    data: $('<?php echo $ukrcredits_selector_block; ?> input[type=\'text\'], <?php echo $ukrcredits_selector_block; ?> input[type=\'hidden\'], <?php echo $ukrcredits_selector_block; ?> input[type=\'radio\']:checked, <?php echo $ukrcredits_selector_block; ?> input[type=\'checkbox\']:checked, <?php echo $ukrcredits_selector_block; ?> select, <?php echo $ukrcredits_selector_block; ?> textarea'),
												                    dataType: 'html',
												                    success: function(modalContent) {
												                        $('#product_credit_popup .content').html(modalContent);
												                    }
												                });
															}	
														}
											...
											<div class="delivery <?php if ($need_ask_about_stock || $can_not_buy) { ?>can_not_buy<?php } ?>">
												...
												<div class="information">
													<a href="javascript:void(0)" onclick="do_notification_block(31,'delivery_block');return false;" data-target="info_delivery" class="do-popup-element" >
														<img src="/catalog/view/theme/kpua/img/pluses-icon-dev.svg" alt="" loading="lazy">
									...
									<?php if($related) { ?>
										<div class="related_slider">
											<div class="head_slider">
												<h3 class="title"><?php echo $text_retranslate_related;?></h3>
												<div class="nav-group">
													<!-- arrows -->
													<div class="swiper-prev-slide" tabindex="0" role="button" aria-label="Previous slide">
													...
													<div class="swiper-next-slide" tabindex="0" role="button" aria-label="Next slide">
														<svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="https://www.w3.org/2000/svg">
									...
									<!--item-bottom-->
									<div class="item-bottom <?php if($related) { ?>has_related<?php } ?>">
									...
									<?php if ($free_delivery) { ?>
										<?php if ($free_delivery == 'moscow') { ?>
											<div class="delivery_info_free ruMoskow">
												<img src="/catalog/view/theme/kpua/img/banner-logo.jpg" alt="" loading="lazy">
			...
			<div class="popup-form" id="product_credit_popup">
				<div class="object">
					<div class="overlay-popup-close"><i class="fas fa-times"></i></div>
					<div class="content"></div>
					<button class="btn-contunie">Продовжити за повну вартість</button>
				</div>
			</div>
			...
			<script type="text/javascript">
				...
				$(document).ready(function() {	
					...
					$('#product_credit_popup .btn-contunie').on('click', function(){
						$('#product_credit_popup .overlay-popup-close').trigger('click');
						setTimeout(function(){
...
//					modal.querySelector('.name_product').textContent = name;  
			...
			<script type="text/javascript">
				...
				$(document).ready(function() {					
					...
					var related_slider = new Swiper('.related_slider .swiper-container', {
						slidesPerView: 'auto',
						loop: true,
						// loopedSlides: 1,
						slidesPerView: 4,
					 	navigation: {
				            nextEl: ".related_slider .swiper-next-slide",
				            prevEl: ".related_slider .swiper-prev-slide",
				        },
						breakpoints: {
							320: {
								slidesPerView: 1,
