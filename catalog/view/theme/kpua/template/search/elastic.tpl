...
<style>
	...
	header .search-scrol--wrap .search-scrol-btn.open{width: 30px;height: 30px;line-height: 25px;font-size: 15px;color: #2121217d;cursor: pointer;background-image: url(/catalog/view/theme/kpua/img/close-modal.svg);background-size: 16px 12px;background-repeat: no-repeat;border: 1px solid #000;text-align: center;background-position: center;opacity: .5;}
