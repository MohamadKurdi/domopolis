		...
		<?php  if ($need_ask_about_stock) { ?>																		
			<div class="waitlist-block" style="display: block;width: 100%">
				<form id="waitlist-form">
					<div class="row">
						<img src="/catalog/view/theme/st/img/Spinners.png" id="ajaxcartloadimg" class="loading_spiner" style="width: 70px;height: 70px;" />
				...
				<?php if(!IS_MOBILE_SESSION) { ?>
					<?php if ($this->config->get('mono_monocheckout_enable')) { ?>
						<button id="monocheckout-checkout-button" class="mono_monocheckout_enable">
							<img src="/catalog/view/theme/st/img/monocheckout_button_black_normal.svg" alt="mono_monocheckout">
						</button>
					<?php } ?>
				<?php } ?>
			</div>
