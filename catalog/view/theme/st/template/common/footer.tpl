                ...
                <div class="footer__links-item applinks_wrap">
                	...
                	<div class="applinks">
						...
						<?php if ($this->config->get('config_android_playstore_enable')) { ?>
							<a href="<?php echo $this->config->get('config_android_playstore_link'); ?>" target="_blank" rel="noindex nofollow"> 
								<?php if ($this->config->get('config_language_id') == 6) { ?>
									<img src="/catalog/view/theme/st/img/gplay_ua.svg" height="55px" loading="lazy" alt="logo google play"> 
									<?php } else { ?>
									<img src="/catalog/view/theme/st/img/gplay_ru.svg" height="55px" loading="lazy" alt="logo google play"> 
								<?php } ?>
							</a> 
						<?php } ?>
                		...
                		<a target="_blank" id="footer_app_button" style="display: none;"> 
                			<?php if ($this->config->get('config_language_id') == 6) { ?>
                				<img src="/catalog/view/theme/st/img/pwa_ua.svg" height="55px" loading="lazy" alt="logo pwa"> 
								<?php } else { ?>
                				<img src="/catalog/view/theme/st/img/pwa_ru_new.svg" height="55px" loading="lazy" alt="logo pwa"> 
							<?php } ?>
						</a> 
					</div>
        ...
        <div class="wrap">
            <div class="footer__container">
                ...
                <ul class="footer__payments">
                        <li>
                            <img src="/catalog/view/theme/st/img/master-card.svg" alt=""  loading="lazy">
						</li>
                        <li>
                            <img src="/catalog/view/theme/st/img/visa.svg" alt=""  loading="lazy">
						</li>
    					<li>
                            <img src="/catalog/view/theme/st/img/LIQPAY.png" alt="" width="47" loading="lazy">
						</li>
				</ul>
			</div>
		</div>
