	...
	<div class="wrap">
		...
		<div class="footer__container">
			...
			<ul class="footer__payments">
					<li>
						<img src="/catalog/view/theme/st/img/master-card.svg" alt="">
					</li>
					<li>
						<img src="/catalog/view/theme/st/img/visa.svg" alt="">
					</li>
					<li>
						<img src="/catalog/view/theme/st/img/LIQPAY.png" alt="" width="47">
					</li>
			</ul>
		</div>
	</div>
