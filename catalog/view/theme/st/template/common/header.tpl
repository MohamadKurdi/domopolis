...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
	...
	<head>
		...
		<style type="text/css">		
			...
			background-image: url(/catalog/view/theme/st/img/load_more.svg);
			}
			.grecaptcha-badge{
			...
			header .search-scrol--wrap .search .button-search{background: #51a881;width: 0;display: none;margin: 0 -2px -2px 0;font-size: 17px;height: 46px;}
			...
			header .search-scrol--wrap .search-scrol-btn.open{width: 30px;height: 30px;line-height: 25px;font-size: 15px;color: #2121217d;cursor: pointer;background-image: url(/catalog/view/theme/st/img/close-modal.svg);background-size: 16px 12px;background-repeat: no-repeat;border: 1px solid #000;text-align: center;background-position: center;opacity: .5;}
			...
			header .top-menu{position:relative;z-index:200;background:#9eea7354}
			header .top-menu .inner{height:55px;display:flex;justify-content:space-between}
			header .icons-link > li button{
			...
			color: #2121217d;
			cursor: pointer;
			background-image: url(/catalog/view/theme/st/img/close-modal.svg);
			...
			@media screen and (min-width: 1000px) {
				.search__field input{
					padding: 0 85px 0 50px !important;
				}
			...
			.header-banner .close{position:absolute;right:40px;width:15px;height:15px;line-height:15px;top:0;bottom:0;margin:auto;cursor:pointer;background-image:url(/catalog/view/theme/st/img/close-modal.svg);background-size:15px 15px;background-repeat:no-repeat;text-align:center;background-position:center;opacity:.5;background-color:transparent}
			...
			content: '';
			background: url(/catalog/view/theme/st/img/snow1.png);
			display: block;
			position: absolute;
			left: 0;
			top: 0;
			...
			@media screen and (max-width:900px){
				.mobile-menu__list .enter_old{
					display: flex;
					flex-direction: column;
					gap: 10px;
					align-items: start !important;
				}
				.mobile-menu__list .enter_old button.profile{
					display: flex;
					    align-items: center;
					    padding: 5px 10px;
					    width: 100%;
			...
			#selectLangue .logo-popup{
				display: block;
    			margin-bottom: 20px;
			}
			#selectLangue .logo-popup svg{
				max-width: 120px;
    			width: 140px;
			}
			#selectLangue .text{
			...
			#selectLangue  .lang-switch{
				display: flex;
			    gap: 50px;
			    align-items: center;
			}
			#selectLangue  .lang-switch a{
			    display: flex;
			    border: 2px solid #57ac79;
			    padding: 10px 38px;
			    font-size: 18px;
			    font-weight: 500;
			    border-radius: 10px;
			}
			#selectLangue  .lang-switch a.main{
				background: #57ac79;
    				color: #fff;
			}
				...
				<div class="head">
					<div class="logo">					
						<a href="<?php echo $home; ?>">
							<img src="/image/data/stores/stores_fastlogo.png" height="60px" />					
						</a>
						</div>
					<!--middle-->
					<div class="middle">
						...
						<div id="search-wrap" class="search">
							...
							<button class="search__btn btn btn_default" type="button" id="main-ajax-search-submit"><?php echo $text_retranslate_13; ?></button>
					...
					<ul class="icons-link">
						...
						<?php if(!IS_MOBILE_SESSION) { ?>
							<li id="account_header" class="<?php if ($logged) { ?>auth<?php } ?> ajax-module-reloadable" data-modpath="common/header/customermenu" data-reloadable-group="customer">
						...
						<div class="menu-horizontal">
							<ul>
								...
								<li >
									...
									<span class="top_menu-horizontal" style="color: #e16a5d;"><?php echo $text_retranslate_22; ?> <b><?php echo $text_retranslate_48; ?></b></span> </a>
								</li>
								<li>
								...
								<li>
									<a href="<?php echo $href_actions; ?>" class="">
										<svg width="20" height="20" viewBox="0 0 20 20" fill="none"
										xmlns="http://www.w3.org/2000/svg">
						...
						<nav>
							...
							<ul>
								...
								<li><a href="<?php echo $href_actions; ?>"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="https://www.w3.org/2000/svg">
									<path d="M18.75 1.25L1.25 18.75M7.25 4.125C7.25 5.85089 5.85089 7.25 4.125 7.25C2.39911 7.25 1 5.85089 1 4.125C1 2.39911 2.39911 1 4.125 1C5.85089 1 7.25 2.39911 7.25 4.125ZM19 15.875C19 17.6009 17.6009 19 15.875 19C14.1491 19 12.75 17.6009 12.75 15.875C12.75 14.1491 14.1491 12.75 15.875 12.75C17.6009 12.75 19 14.1491 19 15.875Z" stroke="#51A881" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
							...
							<?php if(IS_MOBILE_SESSION) { ?>
								<ul>
									<li class="account-menu__mobile ajax-module-reloadable" data-modpath="common/header/customermenu" data-x="m" data-afterload="compileCustomerMenu"></li>
									<script>
