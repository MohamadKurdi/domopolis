...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
	<head>
		...
		<style type="text/css">
			.ukrcredits_wrap .ui-slider.ui-corner-all.ui-slider-horizontal.ui-widget.ui-widget-content{
...
/*				max-width: 350px;*/
			...
			.ukrcredits_wrap .main_wrap_credit{
				background: #f7f4f4;
			    padding: 7px 10px;
			    border-radius: 4px;
			...
			.popup-overlay_credit .popup p{
				font-size: 16px;
				margin-bottom: 25px;
			}
			.popup-overlay_credit button{
			    color: #fff;
			    background: #51a881;
			    font-size: 18px;
			    padding: 7px 23px;
			...
			content: '';
			background-image: url("/catalog/view/theme/st/img/money.svg");
			background-size: contain;
			width: 20px;
			height: 18px;
		...
		<script src="/catalog/view/theme/st/js/sumoselect.min.js"></script>
