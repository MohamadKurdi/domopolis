<?php
	...
	'certificate' => 'catalog/view/theme/default/images/cert-1.jpg',
	);
...
<?php if (isset($informations) && $informations) { ?>
    ...
    <section class="info_block gray-bg">
      	<div class="wrap">        
...
<div id="content" class="presentcerts-page">
	<div class="wrap">
		...
		<link rel="stylesheet" href="catalog/view/theme/st/css/sumoselect.css">
		...
		<div id="information-wrapper-block">
			<?php  
				...
				<div class="img-block-present"><img src="catalog/view/theme/default/image/info-pages/_MG_8728.jpg"></div>
				<?php } elseif ( $this->config->get('config_store_id') == 1){ ?>
				<div class="img-block-present"><img src="catalog/view/theme/default/image/info-pages/_MG_8726.jpg"></div>
			<?php } ?>
