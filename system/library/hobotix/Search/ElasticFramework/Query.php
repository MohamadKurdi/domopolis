...
class Query
{
    ...
    public function getProductByID($product_id)
    {
        try{
            ...
            return $response = $this->registry->get('searchAdaptor')->connection()->get($params);    
    ...
    public function completitionQuery($index, $query, $field, $suggest, $data = [])
    {
        ...
        return $this->registry->get('searchAdaptor')->connection()->search($params);
    }
            ...
            'body' => [
                ...
                'query' => [
                    'bool' => [
                        ...
                        'should' => [
                            ['range' => ['priority' => ['lte' => \hobotix\Search\Elastic::CATEGORY_PRIORITY + 10, 'boost' => 5.0]]],
                            ['range' => ['priority' => ['lte' => \hobotix\Search\Elastic::MANUFACTURER_PRIORITY + 10, 'boost' => 4.0]]],
                            ['range' => ['priority' => ['lte' => \hobotix\Search\Elastic::KEYWORDER_PRIORITY + 10, 'boost' => 3.0]]],
                            ['range' => ['priority' => ['lte' => \hobotix\Search\Elastic::COLLECTION_PRIORITY + 10, 'boost' => 2.0]]]
                        ],
    ...
    public function fuzzyProductsQuery($index, $query, $field1, $field2, $field3, $data = [])
    {
        ...
        if (!empty($data['getTotal'])) {
            ...
            $result = $this->registry->get('searchAdaptor')->connection()->count($params);
        ...
        $results = $this->registry->get('searchAdaptor')->connection()->search($params);
