...
class RainforestOffer
{
    ...
    protected $sellerQuality;
    protected $sellerCountry;
    protected $sellerNative;
    protected $badReason;
    ...
    public function updateFromDataArray($data) {
        ...
        if (!empty($data['delivery'])) {
            if (!empty($data['delivery']['price']['currency'])) {
                $this->setDeliveryCurrency($data['delivery']['price']['currency']);
            }
            if (!empty($data['delivery']['price']['value'])) {
                $this->setDeliveryAmount($data['delivery']['price']['value']);
            }

            if (!empty($data['delivery']['price']['is_free'])) {
        ...
        if (!empty($data['seller'])) {
            ...
            if (!empty($data['seller']['id'])) {
                $this->setSellerID($data['seller']['id']);
            }
    ...
    public function setSellerQuality($value) {
        $this->sellerQuality = $value;
        return $this;
    }
    ...
    public function setSellerNative($value) {
        $this->sellerNative = $value;
        return $this;
    }
    public function setBadReason($value) {
        $this->badReason = $value;
        return $this;
    }
     ...
     * @return string
     */
    public function getSellerQuality()
    {
     ...
     * @return bool
     */
    public function getSellerNative()
    {
